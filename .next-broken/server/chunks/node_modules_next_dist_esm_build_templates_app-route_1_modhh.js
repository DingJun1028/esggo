module.exports=[519348,t=>{"use strict";var e=t.i(747909),r=t.i(174017),d=t.i(996250),i=t.i(759756),l=t.i(561916),a=t.i(174677),n=t.i(869741),o=t.i(316795),p=t.i(487718),s=t.i(995169),h=t.i(47587),c=t.i(666012),_=t.i(570101),u=t.i(626937),m=t.i(10372),y=t.i(193695);t.i(52474);var v=t.i(257297),g=t.i(89171);let R=[{id:"TPL-COMP-01",name:"全面合規基準藍圖",theme:"comprehensive",industry:["製造業","科技業","服務業","金控業","能源業"],totalSections:12,estimatedWords:12e4,sections:[{id:"ch-01",title:"Ch.1 永續治理與策略",chapter:1,wordCount:1e4,griAlignment:["GRI-2-9","GRI-2-10","GRI-2-11","GRI-2-22"],placeholders:["{{company_name}}","{{industry}}","{{report_year}}","{{ceo_name}}","{{board_size}}"],content:`<h2>Ch.1 永續治理與策略</h2>
...
`},{id:"ch-02",title:"Ch.2 環境守護 — 氣候變遷與碳管理",chapter:2,wordCount:1e4,griAlignment:["GRI-302","GRI-303","GRI-305","GRI-306","TCFD"],placeholders:["{{company_name}}","{{industry}}","{{report_year}}","{{carbon_emissions}}","{{energy_consumption}}"],content:`<h2>Ch.2 環境守護 — 氣候變遷與碳管理</h2>

<h3>2.1 氣候治理架構</h3>
<p>{{company_name}} 深知氣候變遷對全球經濟與人類社會的深遠影響，因此將氣候治理列為永續發展的首要議題。本公司由董事會層級負責氣候相關風險與機會的監督管理，永續發展委員會定期審議氣候策略執行情形，並向董事會報告。</p>

<p>本公司已採用氣候相關財務揭露（TCFD）架構，從治理、策略、風險管理、指標與目標四大面向進行完整揭露。同時，本公司已承諾加入科學基礎減量目標倡議（SBTi），設定符合全球升溫控制在 1.5\xb0C 路徑的減量目標。</p>
...
`},{id:"ch-03",title:"Ch.3 社會共融 — 員工福祉與人權",chapter:3,wordCount:1e4,griAlignment:["GRI-401","GRI-402","GRI-403","GRI-404","GRI-405","GRI-406","GRI-413"],placeholders:["{{company_name}}","{{report_year}}","{{employee_count}}","{{female_ratio}}","{{turnover_rate}}"],content:`<h2>Ch.3 社會共融 — 員工福祉與人權</h2>
...
`},{id:"ch-04",title:"Ch.4 誠信經營 — 治理與風險管理",chapter:4,wordCount:1e4,griAlignment:["GRI-2-9","GRI-2-17","GRI-2-25","GRI-205","GRI-418"],placeholders:["{{company_name}}","{{report_year}}","{{board_size}}","{{independent_directors}}","{{compliance_violations}}"],content:`<h2>Ch.4 誠信經營 — 治理與風險管理</h2>
...
`},{id:"ch-05",title:"Ch.5 創新價值 — 研發與數位轉型",chapter:5,wordCount:1e4,griAlignment:["GRI-2-1","GRI-2-4","GRI-417"],placeholders:["{{company_name}}","{{report_year}}","{{rd_investment}}","{{patents}}","{{digital_projects}}"],content:`<h2>Ch.5 創新價值 — 研發與數位轉型</h2>
...
`},{id:"ch-06",title:"Ch.6 價值鏈管理 — 供應商與夥伴關係",chapter:6,wordCount:1e4,griAlignment:["GRI-2-6","GRI-204","GRI-308","GRI-414"],placeholders:["{{company_name}}","{{report_year}}","{{supplier_count}}","{{supplier_audits}}","{{local_sourcing_ratio}}"],content:`<h2>Ch.6 價值鏈管理 — 供應商與夥伴關係</h2>
...
`},{id:"ch-07",title:"Ch.7 社區發展與社會貢獻",chapter:7,wordCount:1e4,griAlignment:["GRI-2-1","GRI-413","GRI-203"],placeholders:["{{company_name}}","{{report_year}}","{{community_investment}}","{{volunteer_hours}}","{{beneficiaries}}"],content:`<h2>Ch.7 社區發展與社會貢獻</h2>
...
`},{id:"ch-08",title:"Ch.8 水資源與廢棄物管理",chapter:8,wordCount:1e4,griAlignment:["GRI-303","GRI-306","GRI-304"],placeholders:["{{company_name}}","{{report_year}}","{{water_withdrawal}}","{{waste_generated}}","{{recycling_rate}}"],content:`<h2>Ch.8 水資源與廢棄物管理</h2>
...
<table>
<tr><th>指標</th><th>{{report_year}}</th><th>前年</th><th>目標</th></tr>
<tr><td>總取水量</td><td>{{water_withdrawal}} m\xb3</td><td>{{prev_withdrawal}} m\xb3</td><td>持續減少</td></tr>
<tr><td>總排水量</td><td>{{water_discharge}} m\xb3</td><td>{{prev_discharge}} m\xb3</td><td>持續減少</td></tr>
...
`},{id:"ch-09",title:"Ch.9 生物多樣性與土地使用",chapter:9,wordCount:1e4,griAlignment:["GRI-304","GRI-101"],placeholders:["{{company_name}}","{{report_year}}","{{land_use}}","{{protected_area}}","{{biodiversity_projects}}"],content:`<h2>Ch.9 生物多樣性與土地使用</h2>
...
`},{id:"ch-10",title:"Ch.10 氣候變遷與TCFD揭露",chapter:10,wordCount:1e4,griAlignment:["TCFD","GRI-201","GRI-302","GRI-305"],placeholders:["{{company_name}}","{{report_year}}","{{tcfd_scenarios}}","{{carbon_price}}","{{climate_investment}}"],content:`<h2>Ch.10 氣候變遷與 TCFD 揭露</h2>
...
<ul>
<li><strong>1.5\xb0C 情境（有序轉型）</strong>：低碳技術投資、能源效率提升</li>
<li><strong>2\xb0C 情境（全球行動）</strong>：政策變革、市場轉型</li>
<li><strong>3\xb0C 情境（轉型失敗）</strong>：極端天氣、實體風險增加</li>
</ul>
...
`},{id:"ch-11",title:"Ch.11 附錄 — GRI 準則索引與數據摘要",chapter:11,wordCount:1e4,griAlignment:["GRI-1","GRI-2","GRI-3"],placeholders:["{{company_name}}","{{report_year}}","{{reporting_period}}","{{auditor}}"],content:`<h2>Ch.11 附錄 — GRI 準則索引與數據摘要</h2>
...
<tr><td>水消耗</td><td>{{water_withdrawal}} m\xb3</td><td>{{prev_water}}</td><td>-20%</td></tr>
...
`},{id:"ch-12",title:"Ch.12 IFRS S1/S2 永續揭露索引",chapter:12,wordCount:1e4,griAlignment:["IFRS-S1","IFRS-S2","ISSB"],placeholders:["{{company_name}}","{{report_year}}","{{sasb_code}}","{{industry_metrics}}"],content:`<h2>Ch.12 IFRS S1/S2 永續揭露索引</h2>
...
<tr><td>{{sasb_code}}-FN-002</td><td>水資源管理</td><td>{{water_withdrawal}} m\xb3</td></tr>
...
`}]}],C={company_name:"善向永續股份有限公司",industry:"科技業",report_year:"2025",ceo_name:"張志明",board_size:"9",independent_directors:"4",female_directors:"3",employee_count:"5,280",female_ratio:"42",female_manager_ratio:"35",turnover_rate:"8.5",turnover_improvement:"2.3",carbon_emissions:"125,000",scope1_emissions:"18,750",scope2_emissions:"43,750",scope3_emissions:"62,500",carbon_intensity:"0.15",prev_intensity:"0.18",target_intensity:"0.10",achievement_rate:"83",energy_consumption:"450,000",energy_intensity:"85",prev_energy:"95",target_energy:"70",energy_achievement:"88",water_withdrawal:"1,200,000",water_discharge:"980,000",water_intensity:"226",prev_water:"250",target_water:"200",water_achievement:"85",water_recycling:"78",waste_generated:"8,500",recycling_rate:"82",prev_recycling:"78",target_recycling:"85",waste_achievement:"92",hazardous_waste:"120",food_waste_recycling:"88",paper_recycling:"96",ltir:"0.8",prev_ltir:"1.2",training_hours:"45",prev_training:"40",community_investment:"2,500",prev_community:"2,200",volunteer_hours:"12,000",volunteer_participation:"35",beneficiaries:"50,000",education_beneficiaries:"15,000",health_beneficiaries:"20,000",env_beneficiaries:"10,000",economic_beneficiaries:"5,000",sroi:"3.5",prev_sroi:"3.2",customer_satisfaction:"92",prev_satisfaction:"90",repurchase_rate:"65",prev_repurchase:"62",nps_score:"55",prev_nps:"50",board_meetings:"12",attendance_rate:"95",prev_attendance:"93",independent_ratio:"44",prev_independent:"44",compliance_violations:"0",supplier_count:"850",supplier_audits:"120",supplier_compliance:"96",prev_compliance:"94",local_sourcing_ratio:"68",prev_local:"65",supplier_diversity:"25",prev_diversity:"22",followup_rate:"85",rd_investment:"8.5",rd_ratio:"5.2",prev_rd_ratio:"4.8",patents:"185",prev_patents:"165",patent_growth:"12",digital_projects:"45",prev_digital:"38",new_product_ratio:"22",prev_new_product:"18",land_use:"150",developed_area:"80",green_area:"45",protected_area:"15",restoration_area:"10",tree_planting:"50,000",prev_trees:"40,000",eco_education:"24",prev_education:"20",tcfd_scenarios:"1.5°C / 2°C / 3°C",carbon_price:"85",renewable_ratio:"45",prev_renewable:"35",tech_cost_reduction:"25",policy_stringency:"中高度",acute_risk_impact:"中度",chronic_risk_impact:"高度",policy_risk_impact:"中度",tech_risk_impact:"中度",market_risk_impact:"中度",reputation_risk_impact:"低度",renewable_investment:"3.5",efficiency_investment:"2.0",tech_investment:"1.5",offset_investment:"0.8",adaptation_investment:"0.7",climate_investment:"8.5",prev_climate:"6.0",internal_carbon_price:"85",prev_internal_cp:"60",sasb_code:"TC-SC",industry_metrics:"研發投入、專利數、數位化成熟度",auditor:"勤誠聯合會計師事務所",reporting_period:"2025年1月1日至12月31日"};async function w(t,e,r,d,i,l){l?.({phase:"loading",currentChapter:0,totalChapters:0,chapterTitle:"載入範本中...",wordCount:0,totalWords:0,estimatedTotal:24e4,provider:"template"});let a=R.find(e=>e.id===t);if(!a)throw Error(`Template not found: ${t}`);let n={...C,company_name:e||C.company_name,industry:r||C.industry,...i};l?.({phase:"assembling",currentChapter:0,totalChapters:a.sections.length,chapterTitle:"組裝報告中...",wordCount:0,totalWords:0,estimatedTotal:a.estimatedWords,provider:"template"});let o=[],p=0;for(let t=0;t<a.sections.length;t++){let e=a.sections[t];l?.({phase:"filling",currentChapter:t+1,totalChapters:a.sections.length,chapterTitle:e.title,wordCount:0,totalWords:p,estimatedTotal:a.estimatedWords,provider:"template"});let r=function(t,e){let r=t;for(let[t,d]of Object.entries(e)){let e=RegExp(`\\{\\{${t}\\}\\}`,"g");r=r.replace(e,d)}return r}(e.content,n),d=function(t){let e=t.match(/[\u4e00-\u9fff]/g)||[],r=t.match(/[a-zA-Z]+/g)||[];return e.length+r.length}(r);p+=d,o.push({id:e.id,title:e.title,content:r,wordCount:d,indicators:e.griAlignment}),l?.({phase:"filling",currentChapter:t+1,totalChapters:a.sections.length,chapterTitle:e.title,wordCount:d,totalWords:p,estimatedTotal:a.estimatedWords,provider:"template"})}return l?.({phase:"done",currentChapter:o.length,totalChapters:o.length,chapterTitle:"完成",wordCount:0,totalWords:p,estimatedTotal:a.estimatedWords,provider:"template"}),{templateId:a.id,templateName:a.name,companyName:n.company_name,industry:n.industry,totalWords:p,chapters:o,generatedAt:new Date().toISOString(),provider:"template"}}async function b(t){try{let{templateId:e,companyName:r,industry:d,customPrompt:i}=await t.json();if(!e)return g.NextResponse.json({error:"templateId is required"},{status:400});let l=new TextEncoder,a=new ReadableStream({async start(t){let a=(e,r)=>{try{t.enqueue(l.encode(`event: ${e}
data: ${JSON.stringify(r)}

`))}catch{}};try{a("started",{message:"開始生成報告...",timestamp:Date.now()});let n=await w(e,r||"示範企業",d||"製造業",i||"",void 0,t=>{a("progress",{phase:t.phase,currentChapter:t.currentChapter,totalChapters:t.totalChapters,chapterTitle:t.chapterTitle,wordCount:t.wordCount,totalWords:t.totalWords,estimatedTotal:t.estimatedTotal})});a("complete",{report:{templateId:n.templateId,templateName:n.templateName,companyName:n.companyName,industry:n.industry,totalWords:n.totalWords,generatedAt:n.generatedAt,chapterCount:n.chapters.length,chapters:n.chapters.map(t=>({id:t.id,title:t.title,wordCount:t.wordCount,indicators:t.indicators}))}}),t.enqueue(l.encode(`event: report
data: ${JSON.stringify(n)}

`))}catch(t){a("error",{error:t instanceof Error?t.message:"Unknown error"})}finally{try{t.close()}catch{}}}});return new Response(a,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive"}})}catch(t){return g.NextResponse.json({error:t instanceof Error?t.message:"Internal server error"},{status:500})}}async function I(){return g.NextResponse.json({status:"ready",maxConcurrent:1})}t.s(["GET",0,I,"POST",0,b,"dynamic",0,"force-dynamic","runtime",0,"nodejs"],881762);var f=t.i(881762);let S=new e.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/sustain-write/generate/route",pathname:"/api/sustain-write/generate",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/sustain-write/generate/route.ts",nextConfigOutput:"",userland:f,...{}}),{workAsyncStorage:G,workUnitAsyncStorage:T,serverHooks:x}=S;async function E(t,e,d){d.requestMeta&&(0,i.setRequestMeta)(t,d.requestMeta),S.isDev&&(0,i.addRequestMeta)(t,"devRequestTimingInternalsEnd",process.hrtime.bigint());let g="/api/sustain-write/generate/route";g=g.replace(/\/index$/,"")||"/";let R=await S.prepare(t,e,{srcPage:g,multiZoneDraftMode:!1});if(!R)return e.statusCode=400,e.end("Bad Request"),null==d.waitUntil||d.waitUntil.call(d,Promise.resolve()),null;let{buildId:C,deploymentId:w,params:b,nextConfig:I,parsedUrl:f,isDraftMode:G,prerenderManifest:T,routerServerContext:x,isOnDemandRevalidate:E,revalidateOnlyGenerated:A,resolvedPathname:N,clientReferenceManifest:F,serverActionsManifest:P}=R,O=(0,n.normalizeAppPath)(g),D=!!(T.dynamicRoutes[O]||T.routes[N]),k=async()=>((null==x?void 0:x.render404)?await x.render404(t,e,f,!1):e.end("This page could not be found"),null);if(D&&!G){let t=!!T.routes[N],e=T.dynamicRoutes[O];if(e&&!1===e.fallback&&!t){if(I.adapterPath)return await k();throw new y.NoFallbackError}}let q=null;!D||S.isDev||G||(q="/index"===(q=N)?"/":q);let j=!0===S.isDev||!D,M=D&&!j;P&&F&&(0,a.setManifestsSingleton)({page:g,clientReferenceManifest:F,serverActionsManifest:P});let U=t.method||"GET",H=(0,l.getTracer)(),B=H.getActiveScopeSpan(),W=!!(null==x?void 0:x.isWrappedByNextServer),$=!!(0,i.getRequestMeta)(t,"minimalMode"),z=(0,i.getRequestMeta)(t,"incrementalCache")||await S.getIncrementalCache(t,I,T,$);null==z||z.resetRequestCache(),globalThis.__incrementalCache=z;let K={params:b,previewProps:T.preview,renderOpts:{experimental:{authInterrupts:!!I.experimental.authInterrupts},cacheComponents:!!I.cacheComponents,supportsDynamicResponse:j,incrementalCache:z,cacheLifeProfiles:I.cacheLife,waitUntil:d.waitUntil,onClose:t=>{e.on("close",t)},onAfterTaskError:void 0,onInstrumentationRequestError:(e,r,d,i)=>S.onRequestError(t,e,d,i,x)},sharedContext:{buildId:C,deploymentId:w}},L=new o.NodeNextRequest(t),J=new o.NodeNextResponse(e),V=p.NextRequestAdapter.fromNodeNextRequest(L,(0,p.signalFromNodeResponse)(e));try{let i,a=async t=>S.handle(V,K).finally(()=>{if(!t)return;t.setAttributes({"http.status_code":e.statusCode,"next.rsc":!1});let r=H.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==s.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let d=r.get("next.route");if(d){let e=`${U} ${d}`;t.setAttributes({"next.route":d,"http.route":d,"next.span_name":e}),t.updateName(e),i&&i!==t&&(i.setAttribute("http.route",d),i.updateName(e))}else t.updateName(`${U} ${g}`)}),n=async i=>{var l,n;let o=async({previousCacheEntry:r})=>{try{if(!$&&E&&A&&!r)return e.statusCode=404,e.setHeader("x-nextjs-cache","REVALIDATED"),e.end("This page could not be found"),null;let l=await a(i);t.fetchMetrics=K.renderOpts.fetchMetrics;let n=K.renderOpts.pendingWaitUntil;n&&d.waitUntil&&(d.waitUntil(n),n=void 0);let o=K.renderOpts.collectedTags;if(!D)return await (0,c.sendResponse)(L,J,l,K.renderOpts.pendingWaitUntil),null;{let t=await l.blob(),e=(0,_.toNodeOutgoingHttpHeaders)(l.headers);o&&(e[m.NEXT_CACHE_TAGS_HEADER]=o),!e["content-type"]&&t.type&&(e["content-type"]=t.type);let r=void 0!==K.renderOpts.collectedRevalidate&&!(K.renderOpts.collectedRevalidate>=m.INFINITE_CACHE)&&K.renderOpts.collectedRevalidate,d=void 0===K.renderOpts.collectedExpire||K.renderOpts.collectedExpire>=m.INFINITE_CACHE?void 0:K.renderOpts.collectedExpire;return{value:{kind:v.CachedRouteKind.APP_ROUTE,status:l.status,body:Buffer.from(await t.arrayBuffer()),headers:e},cacheControl:{revalidate:r,expire:d}}}}catch(e){throw(null==r?void 0:r.isStale)&&await S.onRequestError(t,e,{routerKind:"App Router",routePath:g,routeType:"route",revalidateReason:(0,h.getRevalidateReason)({isStaticGeneration:M,isOnDemandRevalidate:E})},!1,x),e}},p=await S.handleResponse({req:t,nextConfig:I,cacheKey:q,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:T,isRoutePPREnabled:!1,isOnDemandRevalidate:E,revalidateOnlyGenerated:A,responseGenerator:o,waitUntil:d.waitUntil,isMinimalMode:$});if(!D)return null;if((null==p||null==(l=p.value)?void 0:l.kind)!==v.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==p||null==(n=p.value)?void 0:n.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});$||e.setHeader("x-nextjs-cache",E?"REVALIDATED":p.isMiss?"MISS":p.isStale?"STALE":"HIT"),G&&e.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let s=(0,_.fromNodeOutgoingHttpHeaders)(p.value.headers);return $&&D||s.delete(m.NEXT_CACHE_TAGS_HEADER),!p.cacheControl||e.getHeader("Cache-Control")||s.get("Cache-Control")||s.set("Cache-Control",(0,u.getCacheControlHeader)(p.cacheControl)),await (0,c.sendResponse)(L,J,new Response(p.value.body,{headers:s,status:p.value.status||200})),null};W&&B?await n(B):(i=H.getActiveScopeSpan(),await H.withPropagatedContext(t.headers,()=>H.trace(s.BaseServerSpan.handleRequest,{spanName:`${U} ${g}`,kind:l.SpanKind.SERVER,attributes:{"http.method":U,"http.target":t.url}},n),void 0,!W))}catch(e){if(e instanceof y.NoFallbackError||await S.onRequestError(t,e,{routerKind:"App Router",routePath:O,routeType:"route",revalidateReason:(0,h.getRevalidateReason)({isStaticGeneration:M,isOnDemandRevalidate:E})},!1,x),D)throw e;return await (0,c.sendResponse)(L,J,new Response(null,{status:500})),null}}t.s(["handler",0,E,"patchFetch",0,function(){return(0,d.patchFetch)({workAsyncStorage:G,workUnitAsyncStorage:T})},"routeModule",0,S,"serverHooks",0,x,"workAsyncStorage",0,G,"workUnitAsyncStorage",0,T],519348)}];

//# sourceMappingURL=node_modules_next_dist_esm_build_templates_app-route_1_modhh.js.map