...
const mockPages = [
  ...
  },
  {
    ...
    core_purpose: '證據金庫是 ESG GO 平台所有佐證文件（如電費單、ISO 證書、採購合約）的加密儲存與查核中心，是支撐平台「可信度」的最底層防線。',
    ux_experience: '使用者將 PDF 拖入區塊瞬間，系統亮起綠色的 ZKP Verified 與專屬 Hash 碼，建立零摩擦的信任。',
    ...
    acceptance_5t: 'T1-T5 全面實踐：具體化 Hash 值、追溯來源、追蹤生命週期、透明展示、不可篡改保證。',
    design_image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=800'
  },
  {
    id: 5,
    ...
    core_purpose: '提供 ESG GO 系統對「可信度五大原則 (5T Protocol)」的即時合規總覽，確保所有 ESG 數據與報告的完整性、可追溯性與透明度。',
    ux_experience: 'CSO 登入看到五個核心 5T 指標卡片綠燈狀態，可點擊鑽取詳細合規紀錄與數據來源。',
    ui_rwd: '採用「五宮格卡片佈局」作為頂部概覽區，行動端堆疊為垂直列表。',
    data_api: '從 ESG GO 系統的各個模組（evidence_vault、audit_logs 等）撈取合規狀態與事件數據。',
    edge_cases: '1000+ 筆合規紀錄需虛擬化滾動不卡頓，T5 Hash 不符必在 5 秒內轉紅燈。',
    acceptance_5t: 'T1 Tangible：GRI 覆蓋率矩陣；T2 Traceable：數據溯源路徑圖；T3 Trackable：合規事件時間軸；T4 Transparent：AI 透明度分數；T5 Trustworthy：SHA-256 Hash 監控。',
    design_image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=800'
  },
  {
    id: 6,
    ...
    core_purpose: '作為企業永續報告的智慧協作夥伴，透過自動化數據分析、內容生成與合規檢查，提升效率與準確性。',
    ...
    acceptance_5t: 'T1-T4：可追溯分析過程、透明模型來源、具體化數據洞察，不可出現幻覺資訊。',
    design_image: 'https://images.unsplash.com/photo-1677442136019-2178fd29d6d6?auto=format&fit=crop&q=80&w=800'
  },
  {
    id: 7,
    ...
    path: '/editor',
    permission: 'PM, ADMIN',
    core_purpose: '提供 208 頁報告框架、佐證清單與 AI 合規協作，幫助企業高效率產出符合 GRI/ISSB 標準的可信永續報告。',
    ux_experience: 'PM 點擊「AI 擴寫」時，在 3 秒內生成合規草稿，右側抽屜亮起該段落對應的電費單 PDF 縮圖。',
    ui_rwd: '左中右三欄佈局，採用 TipTap 編輯器核心，行動端左右欄收為漢堡選單與懸浮 FAB。',
    data_api: '編輯內容 Autosave 至 Supabase report_drafts 表，佐證文件關聯資訊儲存於 evidence_links 表。',
    edge_cases: '斷網切至離線暫存模式 (IndexedDB)，封印後手動修改必驗使 integrity_hash 驗證失敗報警。',
    acceptance_5t: 'T1-T5：具體化報告框架、追溯佐證連結、追蹤版本紀錄、透明 AI 來源、Trustworthy Hash 封印。',
    design_image: 'https://images.unsplash.com/photo-1555066931-4365d14babf6?auto=format&fit=crop&q=80&w=800'
  }
];
