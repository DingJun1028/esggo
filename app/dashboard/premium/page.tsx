...
const DashboardContent = () => {
  ...
  const latestEvidence = {
    ...
    processTrace: [
      'Scanned by Vision Agent',
      'Mapped to GRI 305-2',
      'T4_Sealed via Pedersen Commitment',
    ],
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-[var(--at-border)]">
        <div className="space-y-3">
          ...
          <p className="text-[var(--at-text-sub)] font-medium max-w-2xl text-sm leading-relaxed">
            指揮官 OmniAgent 就位。5T 誠信協議運行中。透過 Liquid Glass 視覺與 Bento Grid
            佈局，體驗真實不虛的主權治理。
          </p>
        </div>
      ...
      >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-5 rounded-xl bg-[var(--at-bg-card)]/50 border border-[var(--at-border)] group-hover:border-[var(--at-accent)]/30 transition-colors">
                  ...
                  <p className="text-2xl font-black text-[var(--at-text-main)]">
                ...
                <div className="p-5 rounded-xl bg-[var(--at-bg-card)]/50 border border-[var(--at-border)] group-hover:border-emerald-500/30 transition-colors">
                  ...
                  <p className="text-2xl font-black text-emerald-500">
                    85.4 <span className="text-xs font-bold">↑</span>
                  </p>
                </div>
              </div>
            </div>
            <div className="mt-8 flex items-center justify-between border-t border-[var(--at-border)] pt-6">
              <span className="text-[10px] text-[var(--at-text-sub)] font-bold">
                更新於 2 分鐘前
              </span>
              <AtomicButton
                variant="ghost"
                className="text-[var(--at-accent)] hover:bg-[var(--at-accent)]/10"
              >
                進入指揮中心{' '}
                <ArrowRight
                  size={14}
          ...
          >
            <div className="flex justify-between items-start">
              <div className="space-y-2">
                ...
                <h3 className="text-xl font-bold text-[var(--at-text-main)] tracking-tight">
                  社會共融 (S)
                </h3>
                <p className="text-xs text-[var(--at-text-sub)] font-medium">
                  多元化、勞工權益與社區參與。
                </p>
              </div>
            </div>
        ...
        <div className="group">
          ...
          >
            ...
            <div className="space-y-4 relative z-10">
              ...
              <div>
                <h3 className="text-lg font-bold text-[var(--at-text-main)] mb-1 tracking-tight">
                  公司治理 (G)
                </h3>
                <p className="text-[10px] text-[var(--at-text-sub)] uppercase font-bold tracking-tight">
                  Board Performance
                </p>
              </div>
            </div>
        ...
        <div className="group">
          ...
          >
            ...
            <div>
              <p className="text-sm font-black text-[var(--at-text-main)] tracking-tight">
                蜂群活性
              </p>
              <p className="text-[9px] text-[var(--at-text-sub)] uppercase tracking-widest mt-1">
                SustainWrite Active
              </p>
            </div>
          </AtomicCard>
