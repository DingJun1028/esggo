      ...
      <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in- duration-700">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 pb-6 border-b border-slate-200">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-neutral-100 /20 /20 flex items-center justify-center border border-emerald-500/30 shadow-[0_0_30px_rgba(16,185,129,0.15)] relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card
            variant="default"
            className="p-6 transition-all duration-300 hover:border-emerald-500/30"
          >
            ...
            <div className="text-3xl font-black text-white mb-2">
              {metrics.carbonEmissions.toLocaleString()}{' '}
              <span className="text-lg font-normal text-slate-500">tCO₂e</span>
            </div>
          ...
          <Card
            variant="default"
            className="p-6 transition-all duration-300 hover:border-teal-500/30"
          >
            <h3 className="font-bold text-slate-300 flex items-center gap-2 mb-4">
            ...
            <div className="text-3xl font-black text-white mb-2">
              ...
              <span className="text-lg font-normal text-slate-500">kWh</span>
            </div>
          ...
          <Card
            variant="default"
            className="p-6 transition-all duration-300 hover:border-green-500/30"
          >
            <h3 className="font-bold text-slate-300 flex items-center gap-2 mb-4">
