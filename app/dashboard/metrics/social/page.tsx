        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 pb-6 border-b border-white/5">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-black text-white tracking-tight">社�??��? (Social)</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <UniversalCard variant="glass" className="p-6 transition-all duration-300 hover:border-pink-500/30">
            <h3 className="font-bold text-slate-300 flex items-center gap-2 mb-4">
              <Heart size={18} className="text-pink-400" /> ?�工?�任??            </h3>
            ...
            <p className="text-sm text-slate-400 border-t border-white/5 pt-2 flex items-center gap-1">
              <TrendingUp size={14} className="text-emerald-500" /> 較�?�????1.2%
            </p>
          </UniversalCard>

          <UniversalCard variant="glass" className="p-6 transition-all duration-300 hover:border-purple-500/30">
            <h3 className="font-bold text-slate-300 flex items-center gap-2 mb-4">
              <GraduationCap size={18} className="text-purple-400" /> ?��?總�???            </h3>
            <div className="text-3xl font-black text-white mb-2">{metrics.trainingHours.toLocaleString()} 小�?</div>
            <p className="text-sm text-slate-400 border-t border-white/5 pt-2">?��?: 平�?每人 24 小�?</p>
          </UniversalCard>

          <UniversalCard variant="glass" className="p-6 transition-all duration-300 hover:border-blue-500/30">
            <h3 className="font-bold text-slate-300 flex items-center gap-2 mb-4">
              <Briefcase size={18} className="text-blue-400" /> ?��?衛�?�?            </h3>
            <div className="text-3xl font-black text-white mb-2">{metrics.hseIncidents} �?/div>
            <p className="text-sm text-slate-400 border-t border-white/5 pt-2">?�?? ?�失?�傷�?/p>
          </UniversalCard>
        </div>
