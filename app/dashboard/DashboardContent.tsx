...
export default function DashboardContent() {
  ...
  const activities = [
    ...
    },
    {
      id: 2,
      agent: 'ESG_Auditor',
      action: '鎖定 2024 第三季碳排憑證 (Hash: 0x8a9...)',
      time: '5m ago',
      type: 'secure',
    },
    {
  ...
  const allSkills = Array.from(
    new Set(activeAgents.flatMap((agent) => agent.skills?.map((s) => s.nameEN) || []))
  );
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans relative overflow-hidden p-8">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute -top-40 -left-40 w-[600px] h-[600px] bg-cyan-200/40 blur-[120px] rounded-full" />
        <div className="absolute top-20 right-10 w-[500px] h-[500px] bg-emerald-200/30 blur-[150px] rounded-full" />
              ...
              <CardContent className="p-8 flex flex-col h-full">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    className="text-[9px] font-black uppercase text-cyan-600 hover:bg-cyan-50 h-8"
                  >
                ...
                <div className="grid grid-cols-3 gap-4 flex-1">
                  {[
                    ...
                    >
                      <div className={cn('p-3 rounded-xl  w-fit ', dim.color)}>{dim.icon}</div>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  {activities.map((act) => (
                    <div
                      key={act.id}
                      className="flex items-start gap-4 border-b border-slate-800/50 pb-4 last:border-0 last:pb-0"
                    >
                      <div className="mt-1">
                        {act.type === 'success' && (
            ...
            <Card className="h-full border border-slate-200 rounded-3xl shadow-xl">
              <CardContent className="p-8 flex flex-col h-full">
                ...
                <div className="space-y-3 flex-1 flex flex-col justify-center">
                  <a
                    href="/editor"
                    className="w-full flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-cyan-50 to-white border border-cyan-200 text-cyan-900 hover:shadow-md transition-all group"
                  >
                  ...
                  <a
                    href="/vault"
                    className="w-full flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-emerald-50 to-white border border-emerald-200 text-emerald-900 hover:shadow-md transition-all group"
                  >
                    <div className="flex items-center gap-3">
                  ...
                  <a
                    href="/omniguide"
                    className="w-full flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-purple-50 to-white border border-purple-200 text-purple-900 hover:shadow-md transition-all group"
                  >
                    <div className="flex items-center gap-3">
