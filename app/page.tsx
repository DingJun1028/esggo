...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const pulse = setInterval(() => setPulseState(p => !p), 1200);
    return () => { clearInterval(id); clearInterval(pulse); };
  }, []);
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <div
            style={{
              ...
              height: 10,
              borderRadius: "50%",
              background: pulseState ? "#52C41A" : "#38a169",
              boxShadow: pulseState ? "0 0 12px #52C41A" : "none",
        ...
        >
          {FIVE_T.map((t) => (
            <div
              ...
              onMouseEnter={(e) => { (e.currentTarget as HTMLDivElement).style.transform = "translateY(-3px)"; (e.currentTarget as HTMLDivElement).style.borderColor = t.color; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLDivElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLDivElement).style.borderColor = `${t.color}40`; }}
            >
          ...
          <Link key={mod.href} href={mod.href} style={{ textDecoration: "none" }}>
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: mod.accent, fontWeight: 500 }}>{mod.subtitle}</div>
              </div>
              <p style={{ fontSize: 13, color: "#64748b", lineHeight: 1.6, margin: 0 }}>{mod.desc}</p>
