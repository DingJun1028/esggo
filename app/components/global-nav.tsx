        ...
        <div className="flex items-center gap-1">
          {NAV.map((n) => (
            <a
              key={n.href}
              href={n.href}
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[13px] text-textSecondary transition-all duration-200 ${n.color} focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-current`}
            >
              <span>{n.icon}</span>
              <span>{n.label}</span>
            </a>
