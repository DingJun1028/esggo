...
import { Leaf, Plus, BarChart3, Droplets, Zap, Trash2, ShieldCheck, Lock, Loader2, X } from 'lucide-react';
             ...
             {isFormOpen && (
               <div className="absolute inset-0 z-10 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm p-6 flex flex-col justify-center animate-in fade-in zoom-in-95 duration-200">
                 <div className="flex justify-between items-center mb-4">
                   <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">新增環境數據</h3>
