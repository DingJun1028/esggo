...
const CAP = [
  'Week 1-3：永續報告準則與 ZKP 封印實作',
  'Week 4-6：GRI + OmniTag 實作資產',
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          <h2 className="text-lg font-bold text-accentTeal">學習中心</h2>
          <p className="text-xs text-textSecondary">OmniCore 系統操作 × ESG 實務 × 5T 數據治理</p>
        </div>
      </div>
          ...
          <div className="flex gap-3">
            {TRACKS.map((t) => (
              <div key={t.title} className="flex-1 rounded-xl border border-borderColor/60 p-4">
                ...
                <div className="text-[11px] text-textSecondary">{t.weeks} 週 · 實作導向</div>
              </div>
            ))}
          </div>
        </div>
