        ...
        <OmniBaseCard className="p-6 text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            <OmniButton
              variant="primary"
              size="md"
              className="bg-[#003262] hover:bg-[#002244] text-white flex items-center gap-1"
            >
              <span className="flex items-center gap-1"><ShieldCheck size={16} />開始驗證</span>
            </OmniButton>
            <OmniButton variant="outline" size="md" >
              <span className="flex items-center gap-1"><Play size={16} />觀看演示</span>
            </OmniButton>
          </div>
        </OmniBaseCard>
      </div>
