...
import { BadgeCheck, Search, Plus, ShieldCheck, Activity, Brain, Lock, Loader2, X } from 'lucide-react';
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-3 mb-1">
                ...
                <span className="text-xs font-mono text-slate-500 uppercase tracking-widest">PROOF-CENTER</span>
              </div>
              <h1 className="text-4xl font-black text-white tracking-tight">PROOF CENTER</h1>
              <p className="text-slate-400 font-mono text-sm tracking-widest uppercase mt-2">proof-center dashboard</p>
            </div>
          </div>
