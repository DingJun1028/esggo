...
export const OmniGlassCard: React.FC<OmniGlassCardProps> = ({
    ...
    return (
        ...
        >
            {/* 5T Aura Ring (狀態光環) */}
            <div className={`absolute top-0 left-0 w-1 h-full transition-all duration-500 ${isSealed ? 'bg-omni-accent' : 'bg-omni-primary'
                } ${isSealed ? 'shadow-[0_0_15px_#ffd700]' : 'shadow-[0_0_15px_#63a6b0]'}`} />
