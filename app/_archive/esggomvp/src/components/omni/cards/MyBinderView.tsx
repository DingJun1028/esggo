...
import { OmniCard, OmniMiniCard, OmniCardData, RARITY_CONFIG, DIMENSION_CONFIG, TYPE_CONFIG } from "./OmniCard";
        ...
        <div className="flex flex-col gap-4 w-full">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className={`gap-2 flex-col sm:flex-row ${filtersOpen ? "flex" : "hidden sm:flex"}`}>
                    <div className="flex gap-1 p-1 rounded-xl border border-omni-glass-border overflow-x-auto flex-none no-scrollbar" style={{ background: "var(--theme-glass-bg)" }}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1.5 opacity-45 grayscale-[60%]">
                            {filteredLocked.map(card => (
                                <div key={card.card_id} className="relative">
                                    ...
                                    <div className="absolute inset-0 rounded-xl bg-black/25 flex items-center justify-center backdrop-blur-[1px]">
                                        <span className="text-xs text-white/60 font-mono">🔒 LOCKED</span>
                                    </div>
                                </div>
                            ))}
                        </div>
