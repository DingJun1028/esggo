                ...
                <div className="flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex gap-4">
                        {battlePhase === 'READY' && (
                            <button
                                onClick={startBattle}
                                className="flex-1 bg-cyan-600 hover:bg-cyan-500 text-white font-bold h-12 rounded flex items-center justify-center gap-2 uppercase tracking-widest transition-all hover:shadow-[0_0_20px_rgba(6,182,212,0.5)]"
                            >
