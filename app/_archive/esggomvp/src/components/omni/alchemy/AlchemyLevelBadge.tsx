    ...
    return (
        <div className="flex flex-col items-center gap-2 font-black">
            ...
            >
                ...
                {/* The Sigil */}
                <div className="relative z-10 bg-[#050C14] rounded-full border-2 border-current p-1 shadow-2xl">
                ...
                {/* Level Number */}
                <span className="absolute inset-0 flex items-center justify-center z-20 text-white drop-shadow-md">
                    {level}
                </span>
            </motion.div>
