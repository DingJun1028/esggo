                                ...
                                {related.length > 0 ? (
                                    related.map(({ note, similarity }) => (
                                        <div
                                            ...
                                            className="flex items-center justify-between p-1.5 rounded-lg bg-cyan-500/5 border border-cyan-500/10 hover:bg-cyan-500/10 transition-colors cursor-pointer group/link"
                                        >
                                            <div className="flex items-center gap-2 truncate">
                                                ...
                                                />
                                                <span className="text-[9px] text-white/50 truncate group-hover/link:text-cyan-300">
                                                    {note.title}
                                                </span>
                                            </div>
