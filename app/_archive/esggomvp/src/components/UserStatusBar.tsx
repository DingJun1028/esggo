...
export default function UserStatusBar() {
    ...
    return (
        <div className="hidden lg:flex h-10 w-full bg-[var(--surface-2)] border-b border-[var(--glass-border)] items-center justify-between px-8 text-xs font-medium text-[var(--text-sub)]">
