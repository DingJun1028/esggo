...
export default function ReportForgePage() {
    ...
    const [financeImpact, setFinanceImpact] = useState<any>(null);
    ...
    const handleFinalSeal = async () => {
        ...
        // Mocking the forging process with Sentinel feedback
        setTimeout(() => setForgeStage(2), 2000);
        setTimeout(() => setForgeStage(3), 4000);
        setTimeout(() => {
            setForgeStage(4);
            ...
            ReportService.generateEliteReport(
            ...
            >
                ...
                <div>
                    <h4 className="text-sm font-bold text-white mb-1 flex items-center gap-2">
                        ...
                        <span className="px-2 py-0.5 bg-blue-500 text-white text-[9px] rounded-full uppercase tracking-widest font-black">Active</span>
                    </h4>
                ...
                <div className="flex flex-col md:flex-row items-center gap-12 relative z-10 w-full">
                    <div className="flex-1 space-y-6">
                        <div>
                            ...
                            <h2 className="text-2xl md:text-4xl font-black text-white italic tracking-tighter uppercase mb-2">Alpha-Omega Journey</h2>
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <button
                                ...
                                className="px-8 py-5 bg-white/5 border border-white/10 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-white/10 transition-all flex items-center gap-3"
                            >
                ...
                {categories.map((cat, idx) => (
                    ...
                    >
                        <div className="flex justify-between items-center mb-8">
                            ...
                            <span className="text-[10px] font-black tracking-widest text-gray-600 uppercase">Module 0{idx + 1}</span>
                        </div>

                        <h3 className="text-lg font-bold mb-6 text-white group-hover:text-aqua transition-colors">{cat.title}</h3>
                        ...
                        <div className="space-y-3">
                            {cat.features.map((f, fIdx) => (
                                <div key={fIdx} className="flex items-center gap-3 group/item">
                                    ...
                                    <span className="text-[10px] text-gray-400 group-hover/item:text-white transition-colors uppercase tracking-widest">{f}</span>
                                </div>
                            ))}
                    ...
                    >
                        <div className="max-w-xl w-full p-12 text-center space-y-12">
                            ...
                            <div className="space-y-2">
                                <h2 className={`text-3xl font-black italic uppercase tracking-tighter ${hasError ? 'text-red-500' : 'text-white'}`}>
                ...
                {selectedCategory && activeCategoryData && (
                    <>
                        ...
                        <motion.div
                            ...
                            className={`fixed top-0 right-0 h-full w-full max-w-md ${activeCategoryData.color} bg-black/80 backdrop-blur-3xl border-l z-[110] p-8 overflow-y-auto`}
                        >
                            <div className="flex justify-between items-center mb-10">
                                <div className="flex items-center gap-4">
                                    ...
                                    <h3 className="text-2xl font-bold text-white">{activeCategoryData.title}</h3>
                                </div>
                                <button
                                    onClick={() => setSelectedCategory(null)}
            ...
            <AnimatePresence>
                {showActionPanel && (
                    <>
                        ...
                        >
                            <div className="max-w-xl w-full p-8 rounded-3xl bg-black border border-emerald-500/30 shadow-[0_0_100px_rgba(52,211,153,0.1)] pointer-events-auto liquid-glass">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <button
                                        ...
                                        className="w-full p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-aqua/50 hover:bg-aqua/10 transition-all flex items-center justify-between group disabled:opacity-50"
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-left">
                                                <h4 className="font-bold text-white text-sm">{isDownloading ? t.report_forge.downloading : t.report_forge.download_asset}</h4>
                                                <p className="text-[10px] text-gray-500 uppercase tracking-widest">CSV / XLSX Asset with 5T Anchor</p>
                                            </div>
                                        </div>
                                        <ChevronRight size={20} className="text-gray-500 group-hover:text-aqua transition-colors" />
                                    </button>

                                    <button className="w-full p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-emerald-500/50 hover:bg-emerald-500/10 transition-all flex items-center justify-between group">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-left">
                                                <h4 className="font-bold text-white text-sm">{t.report_forge.store_vault}</h4>
                                                <p className="text-[10px] text-gray-500 uppercase tracking-widest">Make it mathematically immutable</p>
                                            </div>
                                        </div>
                                        <ChevronRight size={20} className="text-gray-500 group-hover:text-emerald-400 transition-colors" />
                                    </button>

                                    <button className="w-full p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-blue-500/50 hover:bg-blue-500/10 transition-all flex items-center justify-between group">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-left">
                                                <h4 className="font-bold text-white text-sm">{t.report_forge.view_dashboard}</h4>
                                                <p className="text-[10px] text-gray-500 uppercase tracking-widest">Review visual metrics</p>
                                            </div>
                                        </div>
                                    ...
                                    <button
                                        ...
                                        className="w-full p-3 rounded-xl bg-transparent border border-white/10 text-gray-400 hover:text-white hover:bg-white/5 uppercase tracking-widest font-black text-xs transition-colors"
                                    >
                                        Close
                                    </button>
                                </div>
