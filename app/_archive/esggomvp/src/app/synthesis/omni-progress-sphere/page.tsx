...
export default function OmniProgressMicrosite() {
    ...
    return (
        <div className="min-h-screen bg-[#050810] flex flex-col font-sans text-slate-300 relative overflow-x-hidden selection:bg-[#63a6b0]/30 selection:text-white">
            ...
            <div className="fixed top-[-20%] left-[-10%] w-[70%] h-[70%] bg-[#63a6b0] blur-[180px] opacity-15 rounded-[100%] pointer-events-none mix-blend-screen animate-pulse duration-10000"></div>
            <div className="fixed bottom-[-20%] right-[-10%] w-[60%] h-[60%] bg-indigo-600 blur-[200px] opacity-15 rounded-[100%] pointer-events-none mix-blend-screen"></div>
            ...
            <main className="flex-1 w-full max-w-[1400px] mx-auto p-6 md:p-10 z-10 grid grid-cols-12 gap-8 relative items-start">
                ...
                <div className="col-span-12 xl:col-span-4 flex flex-col gap-6 sticky top-32">
                    <LiquidGlassContainer glowColor="aqua" intensity="medium" className="relative group" coreContext={{ ...baseCore, uuid: "progress-main-sphere" }}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <LiquidGlassContainer glowColor="indigo" intensity="low" coreContext={{ ...baseCore, uuid: "stat-energy" }}>
                            <div className="p-5 flex flex-col gap-2 bg-slate-900/40 rounded-3xl">
                                ...
                                <span className="text-[10px] uppercase tracking-widest text-slate-500 font-mono">Energy Usage (kWh)</span>
                            </div>
                        </LiquidGlassContainer>
                            ...
                            <div className="flex justify-between items-center mb-8">
                                <div>
                                    <h2 className="text-2xl font-black text-white tracking-wide flex items-center gap-3">
                                        Sankey Flow Engine
                                        <span className="px-2.5 py-1 bg-indigo-500/20 text-indigo-300 text-[10px] uppercase tracking-widest rounded-lg border border-indigo-500/30">
                                            Real-time
                                        </span>
                                    </h2>
