...
export default function OmniDemoPage() {
    ...
    return (
        <div className="min-h-screen bg-[#050b10] p-12 text-white font-sans selection:bg-aqua-500/30">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-3 p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
            ...
            <footer className="mt-20 pt-8 border-t border-white/10 text-center text-white/30 text-[10px] tracking-[0.2em] uppercase">
