                ...
                <div className="relative overflow-hidden pt-12 flex flex-col justify-center min-h-[calc(100vh-80px)]">
                    ...
                    <div className="max-w-4xl mx-auto w-full px-6 relative z-10">
                        ...
                        <div className="p-8 md:p-12 rounded-[3rem] border relative overflow-hidden transition-all duration-500 shadow-2xl"
                            style={{ backgroundColor: 'rgba(var(--card-rgb, 20, 20, 20), 0.7)', borderColor: 'var(--border)', backdropFilter: 'blur(20px)' }}>
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 flex flex-col items-center text-center z-10">
                                            <div className="relative group mb-8">
                                                ...
                                                <div className="w-40 h-52 rounded-2xl border-2 flex flex-col items-center justify-center p-6 relative overflow-hidden bg-black/40 backdrop-blur-xl border-white/10 group-hover:border-primary/50 transition-all duration-500 shadow-xl">
                                        ...
                                        <div className="flex-1 text-left space-y-6 z-10 w-full">
                                            <div className="p-8 rounded-[2rem] border relative overflow-hidden group bg-primary/5 border-primary/20">
                                                ...
                                                <div className="flex items-baseline gap-2 mb-4">
                                                    <span className="text-5xl font-black text-white tracking-tighter">{extractedData.value.toLocaleString()}</span>
                                                    <span className="text-lg font-bold opacity-60 text-white leading-none">{extractedData.unit}</span>
                                                </div>
                                                <div className="pt-4 border-t border-primary/10 flex flex-col gap-2">
                                                    <div className="flex justify-between items-center text-[10px]">
                                                        <span className="text-white/40 font-black uppercase tracking-widest">Period</span>
                                                        <span className="text-white font-mono">{extractedData.period}</span>
                                                    </div>
                                                    <div className="flex justify-between items-center text-[10px]">
                                                        <span className="text-white/40 font-black uppercase tracking-widest">Formula</span>
                                            ...
                                            <div className="p-6 rounded-2xl border bg-white/5 border-white/10 space-y-4">
                                                <div className="flex items-center justify-between">
                                                    <h4 className="text-[9px] uppercase tracking-[0.2em] font-black text-foreground/50 flex items-center gap-2">
                                                ...
                                                <p className="text-[10px] font-mono break-all leading-relaxed text-primary/80 bg-black/40 p-4 rounded-xl border border-white/5">
                                                    {hash}
                                                </p>
                                                ...
                                                <AnimatePresence>
                                                    {showHistory && (
                                                        <motion.div
                                                            ...
                                                            animate={{ opacity: 1, y: 0 }}
                                                            exit={{ opacity: 0, y: -10 }}
                                                            className="p-4 bg-black/20 rounded-xl border border-white/5 space-y-3"
                                                        >
                                ...
                                {uploadState === 'submitted' && (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                            <button
                                                className="px-10 py-4 bg-primary text-black font-black uppercase tracking-widest text-xs rounded-2xl hover:bg-white transition-all shadow-xl hover:shadow-white/10"
                                            >
                                                查看您的減碳大禮包
                                            </button>
                                            <button
                                                className="px-10 py-4 border border-white/10 bg-white/5 text-white font-black uppercase tracking-widest text-xs rounded-2xl hover:bg-white/10 transition-all"
                                            >
