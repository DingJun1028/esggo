            ...
            <div className="max-w-6xl mx-auto relative">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-12 gap-4">
                    <div>
                        ...
                        <p className="text-gray-500 font-bold tracking-[0.2em] uppercase text-[10px] mt-2 flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <HelpCircle size={14} className={showGuidance ? "text-aqua" : "text-gray-400"} />
                            Guidance
                        </button>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="group relative p-8 rounded-[2rem] bg-white/5 border border-white/10 hover:border-aqua/50 transition-all">
                        <div className="absolute top-4 right-4 text-gray-600 group-hover:text-aqua transition-colors">
                            <button
                        ...
                        <div className="relative mb-6">
                            <input
                                ...
                                className="w-full bg-black/50 border-2 border-white/10 rounded-2xl px-4 py-8 text-5xl font-black text-white focus:outline-none focus:border-aqua transition-all text-center placeholder:text-gray-800"
                            />
                            <span className="absolute bottom-4 right-6 text-xs font-black text-gray-500 uppercase tracking-widest">kWh</span>
                        </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                            <div className="flex items-center gap-2 text-aqua/60">
                                <Fingerprint size={14} />
                                <span className="text-[9px] font-mono tracking-tighter">0x9f3d...b72a</span>
                            </div>
                            <div className="text-[8px] text-gray-500 uppercase font-black">Source: IoT Sensor Alpha-1</div>
                        </div>
                    </div>
                    ...
                    <div className="p-8 rounded-[2rem] bg-aqua/5 border-2 border-aqua/20 flex flex-col justify-between relative overflow-hidden group">
                        ...
                        <div>
                            ...
                            <div className="text-center space-y-6">
                                ...
                                <div>
                                    <h3 className="text-sm font-black text-white uppercase tracking-widest mb-2">係數解析 (EF)</h3>
                                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/10">
                                        <span className="text-[8px] text-gray-400 font-black uppercase tracking-widest">Global Database</span>
                                        <span className="text-[10px] text-aqua font-black">IPCC v6.0</span>
                                    </div>
                                </div>

                                <div className="p-6 bg-black/40 rounded-2xl border border-aqua/30 backdrop-blur-md">
                                    <span className="block text-[10px] text-gray-500 uppercase tracking-widest mb-3 font-black flex items-center justify-center gap-1">
                    ...
                    <div className="p-8 rounded-[2rem] bg-white/5 border border-white/10 flex flex-col justify-between group">
                        <div>
                            <div className="mb-8 flex items-center justify-between opacity-50">
                                <ShieldCheck size={16} />
                            ...
                            <div className="text-center mb-10">
                                <button
                                    ...
                                    className="mb-4 text-[10px] text-gray-400 font-black uppercase tracking-widest hover:text-aqua transition-colors flex items-center gap-2 mx-auto"
                                >
                                    <Calculator size={12} />
                                ...
                                <motion.div
                                    className="p-4 bg-black rounded-2xl border border-white/5 font-mono text-white text-lg relative group cursor-help"
                                        ...
                                        >
                                            <div className="mt-4 p-4 bg-white/5 rounded-xl border border-white/10 text-left space-y-2">
                                                <div className="flex justify-between text-[10px]">
                                                    <span className="text-gray-500 font-bold uppercase tracking-widest">AD (kWh)</span>
                                                    <span className="text-white font-mono">{inputValue.toLocaleString()}</span>
                                                </div>
                                                <div className="flex justify-between text-[10px]">
                                                    <span className="text-gray-500 font-bold uppercase tracking-widest">EF (kg/kWh)</span>
                                                    <span className="text-white font-mono">{factor}</span>
                                                </div>
                                                <div className="flex justify-between text-[10px]">
                                                    <span className="text-gray-500 font-bold uppercase tracking-widest">GWP (CO2)</span>
                                                    <span className="text-white font-mono">{GWP}</span>
                                                </div>
                                ...
                                {result !== null ? (
                                    ...
                                    >
                                        <div className="relative inline-block">
                                            ...
                                            <div className="absolute -top-4 -right-8 p-1.5 bg-green-500 rounded-full border-4 border-black">
                                                <CheckCircle size={16} className="text-black" />
                                            </div>
                                        </div>
                                        <div className="text-sm font-black text-gray-500 uppercase tracking-[0.2em] flex items-center justify-center gap-2">
                                    ...
                                    >
                                        <div className="w-24 h-24 mx-auto border-4 border-dashed border-white/10 rounded-full flex items-center justify-center mb-6">
                                            <ArrowRight size={32} className="text-gray-800" />
                                        </div>
                                        <p className="text-[10px] text-gray-600 font-black uppercase tracking-widest">Waiting for Execution Protocol</p>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                        </div>
                ...
                <div className="mt-16 text-center">
                    <div className="inline-flex items-center gap-6 px-8 py-4 bg-white/5 rounded-full border border-white/10 backdrop-blur-md">
                        <div className="flex items-center gap-2">
                            <div className="w-2 h-2 rounded-full bg-aqua animate-pulse" />
                            <span className="text-[10px] font-black uppercase tracking-widest text-gray-500">Node Status: <span className="text-white">Active</span></span>
                        </div>
                        <div className="w-[1px] h-4 bg-white/10" />
                        <span className="text-[10px] font-black uppercase tracking-widest text-gray-500">Last Seal: <span className="text-white">2026-03-03 15:30</span></span>
                        <div className="w-[1px] h-4 bg-white/10" />
                        <div className="flex items-center gap-2 text-aqua hover:text-white cursor-pointer transition-colors px-2">
                            <ShieldCheck size={14} />
