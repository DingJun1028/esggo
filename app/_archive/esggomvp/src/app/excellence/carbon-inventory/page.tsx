                        ...
                        >
                            <div className="absolute inset-2 rounded-full border border-aqua/40 flex items-center justify-center">
                                <div className="text-center">
                                    ...
                                    <p className="text-[8px] font-bold text-gray-500 mt-2 uppercase tracking-widest">Excellence Core v12.0</p>
                                </div>
                            </div>
                        ...
                        <div className="mt-12 w-full space-y-4">
                            <div className="p-5 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-between group hover:bg-aqua/5 transition-colors cursor-pointer">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[10px] font-black uppercase tracking-widest text-white">{t.vitals.resilience}</span>
                                        <span className="text-[8px] font-bold text-gray-400">Stable Analysis Mode</span>
                                    </div>
                                </div>
                            ...
                            <div className="p-5 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-between group hover:bg-[#ffd700]/5 transition-colors cursor-pointer">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[10px] font-black uppercase tracking-widest text-white">{t.vitals.lock}</span>
                                        <span className="text-[8px] font-bold text-gray-400">5T Compliant Storage</span>
                                    </div>
                                </div>
                ...
                <div className="xl:col-span-2 flex flex-col gap-8">
                    ...
                    <div className="flex-1 bg-[var(--card-bg)] border border-[var(--card-border)] rounded-[3rem] p-4 shadow-lg overflow-hidden flex flex-col">
                        <div className="p-6 border-b border-white/5 flex justify-between items-center">
                            <div>
                                <h4 className="text-xs font-black uppercase tracking-[0.2em] text-white">{t.charts.funnel_title}</h4>
                                <p className="text-[9px] text-gray-500 uppercase mt-1">{t.charts.funnel_subtitle}</p>
                            </div>
            ...
            <div className="p-10 rounded-[3rem] bg-[var(--card-bg)] border border-[var(--card-border)] liquid-glass shadow-xl">
                <div className="flex justify-between items-center mb-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h4 className="text-sm font-black uppercase tracking-[0.3em] text-white">5T Immutable Audit Trail</h4>
                            <p className="text-[10px] text-gray-500 uppercase tracking-widest mt-1">Real-time ledger entries provided by OmniNexus</p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="md:col-span-2 space-y-3 max-h-[300px] overflow-y-auto pr-4 custom-scrollbar">
                        {auditLog.map((log, idx) => (
                            <div key={idx} className="p-4 bg-black/20 border border-white/5 rounded-2xl flex items-center justify-between group hover:border-aqua/20 transition-all">
                                <div className="flex items-center gap-4">
                                    <span className="text-[9px] font-mono text-aqua opacity-50">#{(idx + 1).toString().padStart(3, '0')}</span>
                                    <p className="text-[10px] font-medium text-gray-300 font-mono">{log}</p>
                                </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between text-[10px]">
                                    ...
                                    <span className="text-white font-bold">42.5 kg/unit</span>
                                </div>
                                <div className="flex justify-between text-[10px]">
                                    <span className="text-gray-500">Hash Protocol</span>
                                    <span className="text-white font-bold">SHA-256</span>
                                </div>
                                <div className="flex justify-between text-[10px]">
                                    <span className="text-gray-500">Block Depth</span>
                                    <span className="text-white font-bold">1,024 Peaks</span>
                                </div>
                            </div>
                        </div>
