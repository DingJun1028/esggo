      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        >
          <Link
            ...
            className="px-12 py-5 rounded-full bg-omni-primary text-[color:var(--theme-bg)] font-black uppercase tracking-[0.3em] text-sm hover:scale-110 hover:shadow-[0_0_50px_var(--theme-primary)] transition-all inline-block group"
          >
