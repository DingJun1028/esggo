...
export default function WuzuoNotePage() {
    ...
    const comicPanels: [ComicPanel, ComicPanel, ComicPanel, ComicPanel] = [
        { id: '1', title: '1. 瞬間靈感', description: '永續洞察往往在意外時刻湧現。無作妙計讓您即時捕捉每一個瞬間。', color: 'accent' },
        { id: '2', title: '2. 自動成章', description: '每則筆記都被賦予結構標籤，幫助您日後追溯知識的來源與脈絡。', color: 'primary' },
        { id: '3', title: '3. 5T 誠信封印', description: '點擊「封印」後，筆記即生成 SHA-256 雜湊，成為不可篡改的永恆資料。', color: 'success' },
        { id: '4', title: '4. 知識資產化', description: '從靈感到資產，無作妙計讓每個想法都化為可交易的知識結晶。', color: 'primary' },
    ];
