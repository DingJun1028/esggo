            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex bg-white/5 rounded-lg p-1 border border-white/5">
                    ...
                    <button
                        ...
                        className={`px-2 py-1 rounded text-[8px] font-bold transition-all ${viewMode === '4D' ? 'bg-cyan-500 text-black border border-cyan-400/20' : 'text-white/40'}`}
                    >
                        4D
                    </button>
                </div>
            ...
            <div className="flex-1 relative flex items-center justify-center border border-dashed border-white/5 rounded-2xl overflow-hidden bg-gradient-to-b from-white/[0.02] to-transparent">
                ...
                {spaceAtoms.map(atom => (
                    <motion.div
                        ...
                        className="absolute w-2 h-2 rounded-full bg-cyan-500 border border-cyan-400/30 cursor-pointer group/atom"
                    >
