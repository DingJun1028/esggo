...
export const ZenEditor: React.FC<Props> = ({ note, onUpdate }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-center mb-12">
                ...
                <div className="flex items-center gap-6">
                    ...
                    {!isSealed && (
                        <button
                            onClick={handleSeal}
                            className="px-6 py-2 rounded-full bg-[var(--theme-primary)] text-[var(--theme-bg)] font-black text-[10px] uppercase tracking-widest hover:brightness-110 active:scale-95 transition-all"
                        >
                            Seal 5T
                        </button>
                    )}
          ...
          ${isSealed ? 'text-white/40' : 'text-white focus:text-[var(--theme-primary)]'}
        `}
          ...
          `}
            ...
            {isSealed && (
                ...
                >
                    ...
                    <Zap size={14} className="text-[var(--color-critical)]" />
                </motion.div>
            )}
        </LiquidGlassContainer>
    );
