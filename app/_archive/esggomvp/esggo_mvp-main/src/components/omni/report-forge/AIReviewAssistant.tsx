                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-1.5 mt-0.5">
                            <div className={`w-1.5 h-1.5 rounded-full ${localStatus === 'reviewing' ? 'bg-amber-400' : 'bg-cyan-400'} border border-white/10`} />
                ...
                {localStatus === 'reviewing' && (
                    ...
                    >
                        <div className="relative">
                            ...
                            <Zap size={20} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-cyan-400" />
                        </div>
