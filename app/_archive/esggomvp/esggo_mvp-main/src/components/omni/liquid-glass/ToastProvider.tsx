...
const TOAST_CFG: Record<ToastType, {
    ...
    success: { border: 'border-emerald-500/30', glow: 'shadow-sm', icon: CheckCircle2, iconColor: 'text-emerald-400', bar: 'bg-emerald-500' },
    error: { border: 'border-rose-500/30', glow: 'shadow-sm', icon: XCircle, iconColor: 'text-rose-400', bar: 'bg-rose-500' },
    warning: { border: 'border-amber-500/30', glow: 'shadow-sm', icon: AlertTriangle, iconColor: 'text-amber-400', bar: 'bg-amber-500' },
    info: { border: 'border-sky-500/30', glow: 'shadow-sm', icon: Info, iconColor: 'text-sky-400', bar: 'bg-sky-500' },
};
