...
export const OMNI_MODULES: Record<string, IOmniModule> = {
    ...
    BUSINESS_RECON_CENTER: {
        domain: 'Adv',
        name: 'Business Reconnaissance Center',
        uuid: 'mod-adv-recon-0001',
        route: '/omni/recon',
        description: '商業偵情中心：S1-S5 全球永續情報監測與 5T 協議驗證。',
        status: 'ACTIVE',
        uiux: 'Liquid Glass 高密度網格，S1-S5 動態過濾，5T 狀態光暈指示。',
        businessLogic: 'S1-S5 情報分類矩陣，5T 閘口鎖定，SHA-256 誠信備份。',
        narrative: '「戰略指揮部」：監測全球變化，將商業情資轉化為具備 5T 誠信的決策依據。',
        teachingGuide: '決策引導：引導使用者理解全球法規與技術趨勢對企業永續競爭力的深遠影響。',
        serviceImpl: 'ReconCenter, IntelCard5T, OmniNcbService, 5T-Gateway。',
        acceptanceCriteria: '情報分類準確率 100%；5T 雜湊鎖定一致性驗證通過；UI 響應時間 < 300ms。'
    }
};
