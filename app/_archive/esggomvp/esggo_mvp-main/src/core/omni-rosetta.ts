...
export class OmniRosetta {
    ...
    static isMojibake(text: string): boolean {
        ...
        // 🛡️ [Enhanced Detection] Check for Private Use Area (PUA) characters (\uE000-\uF8FF)
        // These are almost always symptoms of encoding failure in this context.
        if (/[\uE000-\uF8FF]/.test(text)) return true;

        // Check for single "?" followed by non-ASCII chars
