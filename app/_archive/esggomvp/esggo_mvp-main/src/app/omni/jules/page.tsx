...
function ApiKeyModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-[var(--theme-surface)]/95 border border-[var(--theme-glass-border)] rounded-3xl p-8 w-full max-w-md shadow-2xl backdrop-blur-xl">
                <h3 className="text-xl font-black text-[var(--theme-text-main)] mb-4 flex items-center gap-2">🔑 <span className="text-omni-primary">Omni</span>Jules Access</h3>
                ...
                <input
                    ...
                    className="w-full px-4 py-3 bg-[var(--theme-surface-2)] border border-[var(--theme-glass-border)] rounded-xl text-[var(--theme-text-main)] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-omni-primary/30 mb-6 transition-all"
                />
    ...
    return (
        <div className="min-h-screen bg-omni-bg relative overflow-hidden">
            ...
            <div className="relative z-10 flex h-screen">
                {/* 左側：服務選擇面板 */}
                <aside className="w-80 flex-shrink-0 border-r border-[var(--theme-glass-border)] bg-[var(--theme-surface)]/60 backdrop-blur-xl transition-all shadow-inner">
                ...
                {/* 右側：對話區域 */}
                <main className="flex-1 flex flex-col bg-[var(--theme-bg)]">
                    {/* 標題欄 */}
                    <header className="px-6 py-4 border-b border-[var(--theme-glass-border)] bg-[var(--theme-surface)]/40 backdrop-blur-md">
                    ...
                    {/* 輸入區域 */}
                    <div className="p-4 border-t border-[var(--theme-glass-border)] bg-[var(--theme-surface)]/40 backdrop-blur-md">
                        <div className="flex items-end gap-3">
                            <div className="flex-1 relative">
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 bg-[var(--theme-surface)] border border-[var(--theme-glass-border)] rounded-2xl text-[var(--theme-text-main)] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-omni-primary/30 resize-none disabled:opacity-50 shadow-sm transition-all"
                                    rows={2}
                                />
                            </div>
                            <button
