...
export namespace OmniNamespace {
  export const AGENT = 'omni_agent';
  export const MISSION = 'omni_mission';
  export const ECONOMY = 'omni_economy';
  export const RUNE = 'omni_rune';
  export const PARTNER = 'omni_partner';
  export const SYSTEM = 'omni_system';
}
