...
export const RolePermissions: Record<UserRole, Permission[]> = {
  ...
  [UserRole.VIEWER]: [Permission.VIEW_MY_ESG, Permission.VIEW_DASHBOARD, Permission.VIEW_ANALYTICS],
  [UserRole.GUEST]: [Permission.VIEW_MY_ESG],
};
...
export class AuthService {
  ...
  private async mockLoginAPI(credentials: any): Promise<{
    ...
    // Mock Verification (ONLY enabled in development/test)
    const isMockEnabled = process.env.NODE_ENV !== 'production' || process.env.VITE_ENABLE_MOCK_AUTH === 'true';
