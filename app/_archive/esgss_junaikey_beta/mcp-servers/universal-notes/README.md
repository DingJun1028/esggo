# 萬能筆記 MCP 服務器
# Universal Notes MCP Server

## 📋 概述

萬能筆記 MCP 服務器是一個基於 Model Context Protocol (MCP) 的服務器，提供萬能筆記系統的核心功能接口。它允許 AI 助手通過標準化的 MCP 協議訪問筆記管理、知識庫、同步服務等功能。
...
```json
{
  "mcpServers": {
    "universal-notes": {
      "command": "node",
      "args": [
        "/path/to/mcp-servers/universal-notes/dist/index.js"
      ]
    }
  }
}
...
- [萬能筆記架構文檔](../../docs/UNIVERSAL_NOTES_ARCHITECTURE.md)
