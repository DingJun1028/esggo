#!/bin/bash
# Omni 筆記 MCP 服務器註冊腳本
# Omni Notes MCP Server Registration Script
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Omni 筆記 MCP 服務器註冊工具${NC}"
echo -e "${BLUE}Omni Notes MCP Server Registration${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
EOF
    ...
    # 檢查是否已經註冊
    if grep -q '"omni-notes"' "$CONFIG_FILE"; then
        echo -e "${YELLOW}Omni 筆記 MCP 服務器已經註冊${NC}"
