...
const coursesData = [
  {
    ...
    category: '多代理系統',
    description:
      '學習如何使用 crewAI 框架建構協作型多智能體系統，掌握智能體團隊協作和角色委派技巧。',
    highlights: ['crewAI 框架核心概念', '多智能體協作模式', '角色委派和任務分配', '實際案例實作'],
  ...
  },
  {
    ...
    category: '提示工程',
    description:
      '掌握提示設計、上下文管理和工具使用的基本原理，為建立可靠的 LLM 代理打下堅實基礎。',
    highlights: ['提示設計原則', '上下文管理技巧', '工具使用最佳實務', 'LLM 代理基礎'],
  ...
  },
  {
    ...
    highlights: ['圖基編排概念', '複雜工作流程設計', 'LangGraph 實作練習', '真實案例應用'],
  ...
  },
  {
    ...
    highlights: ['代理架構設計', '決策循環機制', '多代理協作模式', '學術研究方法'],
  ...
  },
  {
    ...
    highlights: ['記憶體管理', '工具整合', '回饋循環設計', 'LangGraph 高級應用'],
  ...
  },
  {
    ...
    highlights: ['多模態數據處理', '圖像和音訊整合', '模型部署策略', 'Nvidia 工具包應用'],
  ...
  },
  {
    ...
    category: '設計模式',
    description:
      '探索使用 AutoGen 建構智能體的可重複使用設計模式，包括角色提示、重試循環和任務規劃。',
    highlights: ['AutoGen 設計模式', '角色提示技巧', '重試循環設計', '任務規劃方法'],
  ...
  },
  {
    ...
    category: '記憶體管理',
    description:
      '學習如何在智能體中實現短期記憶和長期記憶，涵蓋向量儲存、情景記憶和結構化狀態檔案。',
    highlights: ['短期記憶實現', '長期記憶策略', '向量儲存技術', '狀態檔案管理'],
  ...
  },
  {
    ...
    category: 'RAG 代理',
    description:
      '學習如何使用 LlamaIndex 將檢索增強生成 (RAG) 與智慧工作流程結合，適合搜尋和知識庫智能體。',
    highlights: ['RAG 技術原理', 'LlamaIndex 整合', '智慧工作流程', '知識庫代理'],
...
app.get('/api/search', async (req, res) => {
  try {
    ...
    const results = db.data.courses.filter(
      course =>
...
app.post('/api/progress/:userId/:courseId', async (req, res) => {
  try {
    ...
    // 查找或創建進度記錄
    let userProgress = db.data.progress.find(p => p.userId === userId && p.courseId === courseId);
