  ...
  const services = [
    {
      icon: Stethoscope,
      title: 'ESG 健檢服務',
      englishTitle: 'ESG Assessment',
      description: '協助企業快速理解自身永續體質，從「合規」到「創價」一次掌握',
      href: '/health-check-management/health-check',
    ...
    },
    {
      icon: Database,
      title: 'ESG 資訊管理系統',
      englishTitle: 'ESG Information Management System',
      description: '紀錄 × 偵測 × 分析 × 建議 × 報告，一次整合，全面自動化',
      href: '/health-check-management/information-system',
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
              <div className="text-center max-w-4xl mx-auto">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-full mb-6">
                  ...
                  <span className="text-sm font-semibold text-primary">ESG健檢與管理</span>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white rounded-xl p-8 hover:shadow-lg transition-all duration-300">
                  ...
                  <h3 className="text-xl font-bold text-neutral-900 mb-3">雙軌併行</h3>
                  <p className="text-neutral-600">
                    合規型與創價型ESG並重，全面提升企業永續競爭力
                  </p>
                </div>
                <div className="bg-white rounded-xl p-8 hover:shadow-lg transition-all duration-300">
                  <Zap className="w-12 h-12 text-secondary mb-4" />
                  <h3 className="text-xl font-bold text-neutral-900 mb-3">AI智能化</h3>
                  <p className="text-neutral-600">
                    AI驅動的自動化分析與建議，大幅提升效率與準確度
                  </p>
                </div>
                <div className="bg-white rounded-xl p-8 hover:shadow-lg transition-all duration-300">
                  <TrendingUp className="w-12 h-12 text-accent mb-4" />
                  <h3 className="text-xl font-bold text-neutral-900 mb-3">持續優化</h3>
                  <p className="text-neutral-600">
                    從診斷到管理的完整循環，支持企業永續轉型之路
                  </p>
                </div>
              </div>
            </div>
