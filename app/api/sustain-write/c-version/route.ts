...
import { assembleCVersionReport, reportToHtml, reportToMarkdown, getAvailableCompanies } from '@/src/lib/sustain-write';
import { jsonResponse, jsonError } from '@/src/lib/api-utils';
import type { ReportChapter } from '@/src/lib/sustain-write/omni-tag';
