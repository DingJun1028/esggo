      ...
      {open && (
        ...
        >
          ...
          {item.formula && (
            ...
            >
              <div
                style={{ fontSize: '11px', fontWeight: 700, color: '#92400e', marginBottom: '3px' }}
              >
                計算公式
              </div>
              <code style={{ fontSize: '12px', color: '#374151', fontFamily: 'monospace' }}>
                {item.formula}
              </code>
              {item.unit && (
...
function StandardCard({ standard, onClick }: { standard: Standard; onClick: () => void }) {
  return (
    ...
    >
      ...
      <div style={{ fontSize: '14px', fontWeight: 800, color: '#003262', marginBottom: '4px' }}>
        {standard.code}
      </div>
      <div
        style={{
...
function StandardDetail({ standard, onClose }: { standard: Standard; onClose: () => void }) {
  const colors = CATEGORY_COLORS[standard.category] ?? {
    bg: '#f3f4f6',
    text: '#374151',
    border: '#e5e7eb',
  };
        ...
        >
          ...
          >
            <div>
              ...
              <div
                style={{ fontSize: '22px', fontWeight: 800, color: '#1a1a2e', marginBottom: '4px' }}
              >
                {standard.code}
              </div>
    ...
    <div style={{ padding: '24px', maxWidth: '1280px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '28px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '8px' }}>
          ...
          <div>
            <h1 style={{ fontSize: '24px', fontWeight: 800, color: '#1a1a2e', lineHeight: 1 }}>
              永續規範書總庫
            </h1>
        ...
        >
          {[
            ...
            {
              label: '申報時程',
              value: COMPLIANCE_TIMELINE.length,
      ...
      {activeTab === 'timeline' && (
        ...
        >
          <div
            style={{ fontSize: '16px', fontWeight: 800, color: '#1a1a2e', marginBottom: '20px' }}
          >
            📅 ESG 申報合規時程表
          </div>
          <div style={{ position: 'relative' }}>
            <div
              style={{
                ...
                bottom: 0,
                width: '2px',
                background: 'linear-gradient(to bottom, #003262, #e5e7eb)',
              }}
            />
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      height: '12px',
                      borderRadius: '50%',
                      background: item.urgent ? '#dc2626' : '#003262',
                      flexShrink: 0,
                      marginTop: '4px',
                      position: 'relative',
                      zIndex: 1,
                      boxShadow: item.urgent ? '0 0 0 4px #fee2e2' : '0 0 0 4px #dbeafe',
                    }}
                  />
                  <div
                    style={{
                      ...
                      borderRadius: '10px',
                      padding: '12px 16px',
                      border: `1px solid ${item.urgent ? '#fecaca' : '#e5e7eb'}`,
                    }}
                  >
                    <div
                      style={{
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '700px' }}>
              <thead>
                <tr style={{ background: '#f9fafb' }}>
                  ...
                  {['GRI 2021', 'GRI 305', 'TCFD', 'ISSB S2', 'ISO 14064', '金管會', 'CSRD'].map(
                    (h) => (
                      <th
                        key={h}
                        style={{
