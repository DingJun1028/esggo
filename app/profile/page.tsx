        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCompanyInfo({ ...companyInfo, registrationId: e.target.value })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCompanyInfo({ ...companyInfo, foundedYear: e.target.value })
                    }
                    className="w-full p-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-teal-500 outline-none transition"
                  />
                </div>
          ...
          <Card variant="default" className="p-6">
            ...
            <div className="mt-8 p-4 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-600">
              ...
              此處輸入的個人資料將受到 <strong>ESGGO 5T 隱私遮蔽協議</strong> 與{' '}
              <strong>台灣個人資料保護法</strong>{' '}
              保護。在匯出報告時，我們會自動依據您的隱私設定進行適當的遮蔽 (ZKP 處理)。
            </div>
          </Card>
        </div>
      </div>
