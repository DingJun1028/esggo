  ...
  const handleRestoration = async (
    ...
    try {
      ...
      const res = await fetch('/api/agent/v3/execute', {
        ...
        body: JSON.stringify({
          prompt: `執行萬能修復協議：${protocol}。請診斷系統中的亂碼與邏輯斷層，並進行自動修復。`,
        }),
      });
      ...
      emitEvent({
        type,
        payload: `[Omni Restoration] Error executing ${protocol}`,
        integrity_hash: '0xERR',
      });
    }
  };
            ...
            <div className="text-left">
              ...
              <div
                className={`text-xl font-bold font-mono transition-colors duration-300 ${
                  pulseActive ? 'text-cyan-300 scale-105' : 'text-cyan-400'
                }`}
              >
                {rs.toFixed(6)}
              </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-3 font-mono text-xs pr-2 max-h-[500px] lg:max-h-none">
                ...
                return (
                  ...
                  >
                    <div className="flex flex-wrap justify-between items-center gap-2 text-[10px]">
                      <div className="flex items-center gap-2">
                        <span
                          className={`px-1.5 py-0.5 rounded border text-[9px] font-bold ${typeColor}`}
                        >
                          {tag}
                        </span>
                    ...
                    <div className="flex justify-between items-center text-[9px] text-slate-500 px-2 py-1 rounded">
              ...
              {events.length === 0 && (
                <div className="h-full flex flex-col items-center justify-center text-slate-500 py-24 gap-3">
                  <svg
                    className="w-8 h-8 text-slate-700 animate-spin"
                    fill="none"
                    viewBox="0 0 24 24"
                  >
                    <circle
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className="flex justify-between items-center relative z-10">
                    ...
                    <span className="opacity-0 group-hover:opacity-100 text-emerald-400 font-mono text-[10px] transition-opacity duration-300">
                      ACTIVATE
                    </span>
                  </div>
                </button>
                ...
                <button
                  onClick={() =>
                    emitEvent({
                      type: 'COMPUTE',
                      payload: '[OmniRune] 萬能符文已解鎖，準備重組 Atomic Functions...',
                      integrity_hash: '0xRUNE',
                    })
                  }
                ...
                >
                  ...
                  <div className="flex justify-between items-center relative z-10">
                    ...
                    <span className="opacity-0 group-hover:opacity-100 text-purple-400 font-mono text-[10px] transition-opacity duration-300">
                      FORGE
                    </span>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="flex justify-between items-center relative z-10">
                    ...
                    <span className="opacity-0 group-hover:opacity-100 text-cyan-400 font-mono text-[10px] transition-opacity duration-300">
                      AWAKEN
                    </span>
                  </div>
                </button>
                ...
                <button
                  onClick={() =>
                    emitEvent({
                      type: 'SEAL',
                      payload: '[OmniTag] 萬能標籤掃描中，重構語義網絡矩陣...',
                      integrity_hash: '0xTAG',
                    })
                  }
                ...
                >
                  ...
                  <div className="flex justify-between items-center relative z-10">
                    ...
                    <span className="opacity-0 group-hover:opacity-100 text-rose-400 font-mono text-[10px] transition-opacity duration-300">
                      INDEX
                    </span>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="flex justify-between items-center relative z-10">
                    ...
                    <span className="opacity-0 group-hover:opacity-100 text-amber-400 font-mono text-[10px] transition-opacity duration-300">
                      LEARN
                    </span>
                  </div>
                </button>
