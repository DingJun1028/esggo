...
const SURVEY_QUESTIONS: SurveyQuestion[] = [
  ...
  },
  {
    ...
    topicZh: '水資源與廢棄物',
    category: 'E',
    griReference: 'GRI 303/306',
    question: '水資源管理與廢棄物減量的重要性',
  },
  {
    id: 'q5',
  ...
  },
  {
    ...
    topicZh: '人權',
    category: 'S',
    griReference: 'GRI 408-414',
    question: '供應鏈人權盡職調查的迫切性',
  },
  {
    id: 'q8',
  ...
  },
  {
    ...
    question: '資訊安全與個人資料保護的優先程度',
  },
  {
    id: 'q11',
    topic: 'Supply Chain ESG',
    topicZh: '供應鏈 ESG',
    category: 'G',
    griReference: 'GRI 308/414',
    question: '供應商 ESG 評核與管理的必要性',
  },
  {
    id: 'q12',
    topic: 'Transparency',
    topicZh: '資訊透明度',
    category: 'G',
    griReference: 'GRI 2-22',
    question: '永續報告書揭露完整性的重要性',
  },
];
...
const MOCK_STAKEHOLDERS: Stakeholder[] = [
  {
    id: '1',
    name: '陳建宏',
    organization: '台灣碳盤查協會',
    type: 'external',
    email: 'chen@esg.org.tw',
    influence: 4,
    concern: 5,
...
export default function StakeholderSurveyPage() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'list' | 'results' | 'matrix'>(
    'overview'
  );
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1280px', margin: '0 auto' }}>
      ...
      <div
        style={{
          background: 'linear-gradient(135deg, #003262, #1a4d7a)',
          borderRadius: '18px',
          padding: '26px 28px',
          marginBottom: '24px',
          position: 'relative',
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '16px' }}>
            ...
            <div>
              <h1 style={{ fontSize: '20px', fontWeight: 900, color: 'white', lineHeight: 1 }}>
                利害關係人問卷系統
              </h1>
              <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.6)', marginTop: '4px' }}>
                Stakeholder Survey · GRI 2-29 · 3-1/3-2 重大性評估
              </p>
            </div>
          </div>
            ...
            {[
              ...
              >
                <div style={{ fontSize: '20px', fontWeight: 800, color: s.color, lineHeight: 1 }}>
                  {s.value}
                  {s.sub && <span style={{ fontSize: '12px', marginLeft: '2px' }}>{s.sub}</span>}
                </div>
      ...
      {activeTab === 'overview' && (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
          ...
          >
            <h2
              style={{ fontSize: '14px', fontWeight: 800, color: '#1a1a2e', marginBottom: '16px' }}
            >
              問卷回覆進度
            </h2>
            <div style={{ marginBottom: '16px' }}>
              ...
              >
                ...
                <span style={{ fontSize: '16px', fontWeight: 800, color: '#003262' }}>
                  {responseRate}%
                </span>
              </div>
              <div
              ...
              >
                <div
                  style={{
                    height: '100%',
                    width: `${responseRate}%`,
                    background: 'linear-gradient(90deg, #003262, #3b7ea1)',
                    borderRadius: '5px',
              ...
              <div key={q.id} style={{ marginBottom: '12px' }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <span
                      style={{ fontSize: '11px', fontWeight: 700, color: '#9ca3af', width: '16px' }}
                    >
                      #{i + 1}
                    </span>
                  ...
                  <span style={{ fontSize: '14px', fontWeight: 800, color: '#003262' }}>
                    {q.avgScore}
                  </span>
                </div>
                <div
                  ...
                  <div
                    style={{
                      ...
                      background: `linear-gradient(90deg, ${
                        q.category === 'E' ? '#16a34a' : q.category === 'S' ? '#7c3aed' : '#d97706'
                      }, #003262)`,
                      borderRadius: '3px',
                    }}
                  />
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
              {Object.entries(TYPE_CFG).map(([k, v]) => {
                ...
                const completed_count = stakeholders.filter(
                  (s) => s.type === k && s.surveyStatus === 'completed'
                ).length;
                return (
                  <div
                    key={k}
                  ...
                  >
                    ...
                    >
                      <div
                        style={{
                          height: '100%',
                          width: `${count > 0 ? (completed_count / count) * 100 : 0}%`,
                          background: v.color,
                          borderRadius: '2px',
                        }}
                      />
                          ...
                          {[1, 2, 3, 4, 5].map((n) => (
                            <div
                              ...
                              style={{
                                ...
                                height: '10px',
                                borderRadius: '2px',
                                background: n <= s.influence ? '#003262' : '#e5e7eb',
                              }}
                            />
                          ))}
                        </div>
                          ...
                          {[1, 2, 3, 4, 5].map((n) => (
                            <div
                              ...
                              style={{
                                ...
                                height: '10px',
                                borderRadius: '2px',
                                background: n <= s.concern ? '#FDB515' : '#e5e7eb',
                              }}
                            />
                          ))}
                        </div>
                    ...
                    <td style={{ padding: '12px 14px' }}>
                      <span
                        style={{
                          fontSize: '18px',
                          fontWeight: 800,
                          color: isHigh ? '#16a34a' : isMed ? '#d97706' : '#6b7280',
                        }}
                      >
                        {q.avgScore}
                      </span>
                      ...
                      >
                        <div
                          style={{
                            height: '100%',
                            width: `${(q.avgScore / 5) * 100}%`,
                            background: isHigh ? '#16a34a' : isMed ? '#d97706' : '#9ca3af',
                            borderRadius: '4px',
                          }}
                        />
                      </div>
                    ...
                    <td style={{ padding: '12px 14px' }}>
                      <span
                        style={{
                          ...
                          fontSize: '11px',
                          fontWeight: 700,
                          background: isHigh ? '#dcfce7' : isMed ? '#fef3c7' : '#f3f4f6',
                          color: isHigh ? '#16a34a' : isMed ? '#d97706' : '#9ca3af',
                        }}
                      >
      ...
      {activeTab === 'matrix' && (
        ...
        >
          <h2 style={{ fontSize: '14px', fontWeight: 800, color: '#1a1a2e', marginBottom: '20px' }}>
            影響力 × 關注度矩陣
          </h2>
          <div
            style={{
          ...
          >
            ...
            >
              <div>
                ...
                <div
                  style={{ fontSize: '12px', color: 'rgba(255,255,255,0.65)', marginTop: '2px' }}
                >
                    ...
                    return (
                      <div key={q.id} style={{ marginBottom: '10px' }}>
                        ...
                        >
                          ...
                          <span style={{ fontSize: '12px', fontWeight: 700, color: '#003262' }}>
                            {score}/5
                          </span>
                        </div>
                        <div
                        ...
                        >
                          <div
                            style={{
                              ...
                              width: `${(score / 5) * 100}%`,
                              background:
                                score >= 4 ? '#16a34a' : score >= 3 ? '#d97706' : '#9ca3af',
                              borderRadius: '3px',
                            }}
                          />
                        </div>
