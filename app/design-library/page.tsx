          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-3 mb-1">
                ...
                <span className="text-xs font-mono text-slate-500 uppercase tracking-widest">DESIGN-LIBRARY</span>
              </div>
              <h1 className="text-4xl font-black text-white tracking-tight">DESIGN LIBRARY</h1>
              <p className="text-slate-400 font-mono text-sm tracking-widest uppercase mt-2">design-library dashboard</p>
            </div>
          </div>
