...
const ALL_ITEMS: SearchResult[] = [
  {
    ...
    title: 'Dashboard',
    titleZh: '控制台',
    description: 'KPI 儀表板、GRI 覆蓋率、5T 活動日誌、模組進度追蹤',
    module: 'CORE',
    href: '/',
    category: 'page',
    tags: ['KPI', 'GRI', '5T'],
  ...
  },
  {
    ...
    title: 'SustainWrite',
    titleZh: '永續撰寫',
    description: '208頁 GRI 2021 完整框架，SPIRIT AI 人格協助撰寫，5T 封印',
    module: 'CORE',
    href: '/editor',
    category: 'page',
    tags: ['GRI', 'AI', 'ZKP'],
  ...
  },
  {
    ...
    titleZh: '證據金庫',
    description: '佐證文件管理、ZKP 零知識驗算、SHA-256 Hash Lock',
    module: 'GOVERNANCE',
    href: '/vault',
    category: 'page',
    tags: ['ZKP', 'SHA-256', '5T'],
  ...
  },
  {
    ...
    titleZh: '環境指揮',
    description: 'GHG 盤查、能源管理、水資源、廢棄物，GRI 302-306',
    module: 'E-S-G',
    href: '/environmental',
    category: 'page',
    tags: ['GHG', 'GRI 305', 'ISO 14064'],
    icon: <Leaf size={14} />,
  },
  {
    id: '5',
    title: 'GRI Tracker',
    titleZh: 'GRI 追蹤器',
    description: '28項 GRI 2021 指標狀態追蹤，完成度儀表板，CSV 匯出',
    module: 'REPORT',
    href: '/gri-tracker',
    category: 'page',
    tags: ['GRI 2021', '合規', '追蹤'],
  ...
  },
  {
    ...
    titleZh: 'CBAM 試算器',
    description: '歐盟碳邊境稅試算，6大產業，年度費用計算',
    module: 'REPORT',
  ...
  },
  {
    ...
    titleZh: '規範書總庫',
    description: 'GRI/SASB/TCFD/ISSB/ISO/金管會/CSRD 規範索引',
    module: 'REPORT',
    href: '/standards',
    category: 'page',
    tags: ['GRI', 'TCFD', 'ISSB', 'ISO'],
  ...
  },
  {
    ...
    titleZh: '淨零路線圖',
    description: 'SBTi 減碳里程碑、碳排趨勢圖、2030 目標追蹤',
    module: 'INSIGHTS',
    href: '/roadmap',
    category: 'page',
    tags: ['SBTi', '淨零', '2030'],
  ...
  },
  {
    ...
    title: 'Digital Twin',
    titleZh: '數位分身',
    description: '知識倉庫 RAG、道德 DNA 建模、主權帳本、AI 對話',
    module: 'CORE',
    href: '/digital-twin',
    category: 'page',
    tags: ['RAG', 'AI', '知識庫'],
  ...
  },
  {
    ...
    title: 'Health Check',
    titleZh: '企業健檢',
    description: '15題 ESG 自評、E/S/G 分類評分、90天改善路線圖',
    module: 'CORE',
    href: '/health-check',
    category: 'page',
    tags: ['健檢', 'ESG', '路線圖'],
  ...
  },
  {
    ...
    title: 'GRI 305-1',
    titleZh: '直接溫室氣體排放',
    description: '範疇一直接排放量，公式：Σ(活動數據 × 排放係數)，單位：tCO₂e',
    module: 'GRI',
    href: '/gri-tracker',
    category: 'gri',
    tags: ['GRI 305', '範疇一', 'tCO₂e'],
    icon: <Leaf size={14} />,
  },
  {
    id: '12',
    title: 'GRI 305-2',
    titleZh: '能源間接排放',
    description: '範疇二電力排放，公式：用電度數 × 電力排放係數',
    module: 'GRI',
    href: '/gri-tracker',
    category: 'gri',
    tags: ['GRI 305', '範疇二', '電力'],
  ...
  },
  {
    ...
    title: 'TCFD',
    titleZh: '氣候相關財務揭露',
    description: '治理、策略、風險管理、指標與目標四大支柱',
    module: 'Standard',
    href: '/standards',
    category: 'standard',
    tags: ['TCFD', '氣候', '財務'],
  ...
  },
  {
    id: '15',
    title: 'ISSB S2',
    titleZh: 'IFRS S2 氣候揭露',
    description: 'Scope 1/2/3 排放、氣候情境分析、碳強度指標',
    module: 'Standard',
    href: '/standards',
    category: 'standard',
    tags: ['ISSB', 'IFRS', 'S2'],
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '800px', margin: '0 auto' }}>
      <div style={{ marginBottom: '28px' }}>
        <h1 style={{ fontSize: '22px', fontWeight: 800, color: '#1a1a2e', marginBottom: '16px' }}>
          全域搜尋
        </h1>
      ...
      {!query && (
        <div>
          <div
            style={{ fontSize: '13px', fontWeight: 700, color: '#9ca3af', marginBottom: '14px' }}
          >
            快速訪問
          </div>
          <div
