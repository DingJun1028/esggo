              ...
              {aiRecommendations.length > 0 && activeTab === 'benchmarks' && (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <BrandButton variant="ghost" size="sm" onClick={() => setAiRecommendations([])}>
                      清除
                    </BrandButton>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {aiRecommendations.map((rec: any, i) => (
                      <BrandCard
                        key={i}
                        hover
                        padding="md"
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mt-auto">
                          <BrandBadge variant="info" size="xs">
                            {rec.gri}
                          </BrandBadge>
                          <BrandButton
                            variant="primary"
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {t.t5ready && (
                          <BrandBadge variant="success" size="xs" className="scale-75 origin-left">
                            5T Ready
                          </BrandBadge>
                        )}
                      </div>
                ...
                <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedPractice.tags.map((t: string) => (
                      <BrandBadge key={t} variant="info" size="xs">
                        {t}
                      </BrandBadge>
                    ))}
                  </div>
                ...
                <div className="p-6 bg-[#003262] rounded-[2.5rem] text-white space-y-4 relative overflow-hidden shadow-2xl">
                  <div className="relative z-10 space-y-4">
                    ...
                    <p className="text-sm text-blue-100/90 leading-relaxed font-medium italic">
                      「偵測到您的企業在 ${selectedPractice.industry}{' '}
                      中具備相似的組織結構。建議導入其 5T 自動化驗算模型，可大幅降低合規缺口風險。」
                    </p>
                    <BrandButton
                      variant="primary"
                      fullWidth
