      ...
      <div className="relative z-10 max-w-[1440px] mx-auto min-h-screen flex flex-col">
        ...
        <header
          className={cn(
            ...
            isDark ? 'border-gray-800/40 bg-[#0B0F19]/50 -md' : 'border-gray-200/60  -md'
          )}
        >
          {/* Logo Group */}
          <div className="flex items-center gap-3">
            <div className="relative flex items-center justify-center">
              ...
              <Activity
                className={cn(
                  'w-5.5 h-5.5 transition-colors duration-500 relative z-10',
            ...
            <span
              className={cn(
                'font-bold text-lg tracking-wider transition-colors duration-500',
            ...
            <div
              className={cn(
                ...
                isDark
                  ? 'bg-[#22D3EE]/10 text-[#22D3EE] shadow-[0_0_10px_rgba(34,211,238,0.05)]'
                  : 'bg-[#22D3EE]/10 text-[#0891B2]'
              )}
            >
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            {['Weave Engine', 'Formula Lab', 'Audit Ledger'].map((link) => (
              <span
                ...
                onClick={() => {
                  setCustomLogs((prev) => [
                    `>> [NAV] Navigating to simulated ${link} workspace...`,
                    ...prev.slice(0, 5),
                  ]);
                }}
                className={cn(
        ...
        <main className="flex-1 p-6 md:p-8 flex flex-col gap-6 relative z-10">
          ...
          <div
            className={cn(
              ...
              isDark ? 'bg-[#111827]/60 border-gray-800/40 -md ' : ' border-gray-200/50 -md '
            )}
          >
            <div className="flex items-center gap-3">
              <div
              ...
              <div>
                ...
                >
                  TENANT: <span className="text-[#22D3EE] font-bold">ESGGO-CORE</span> | TRUST NODE:
                  SECURE_LEDGER_BLOCK_#2026
                </p>
              </div>
            </div>
            ...
            <div
              className={cn(
                ...
                isDark
                  ? 'bg-[#020617] border-gray-800/60 text-[#22D3EE]'
                  : 'bg-gray-100 border-gray-200 text-[#0891B2]'
              )}
            >
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[440px_1fr_420px] gap-6 items-start">
            ...
            <div className="flex flex-col gap-6 w-full">
              ...
              <div
                className={cn(
                  'rounded-2xl border transition-all duration-500 flex flex-col overflow-hidden -md ',
                  isDark
              ...
              >
                ...
                <div className="p-[18px] flex items-center justify-between border-b border-gray-800/10 dark:border-gray-700/10">
                  <div className="flex flex-col gap-0.5">
                    <span
                      className={cn(
                        'text-[15px] font-bold tracking-wide transition-colors duration-500',
                        isDark ? 'text-[#F9FAFB]' : 'text-[#111827]'
                      )}
                    >
                      Scope 1 Emissions
                ...
                <div className="p-[18px] flex flex-col gap-4">
                  ...
                  <div className="flex items-baseline gap-1.5">
                    <span
                      className={cn(
                        'text-[28px] font-black tracking-tight leading-none transition-colors duration-500',
                        isDark ? 'text-[#F9FAFB]' : 'text-[#111827]'
                      )}
                    >
                      {(4210.8 * metricMultiplier).toLocaleString('en-US', {
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        'text-[10px] flex items-center gap-1 transition-colors duration-500',
                        isDark ? 'text-[#9CA3AF]' : 'text-[#4B5563]'
                      )}
                    >
                      <span className="text-emerald-500 text-xs leading-none">✓</span> Validated:
                      EPA 2026 Emission Factors
                    </span>
                  </div>
                </div>
                ...
                <div className="p-[18px] pt-0 flex items-center justify-between mt-auto">
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() =>
                        triggerTrace('Scope 1 Emissions', [
              ...
              <div
                className={cn(
                  'rounded-2xl border transition-all duration-500 flex flex-col overflow-hidden -md  relative',
                  isDark
              ...
              >
                ...
                <div className="p-[18px] flex items-center justify-between border-b border-gray-800/10 dark:border-gray-700/10">
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        'text-[9px] font-black tracking-wider transition-colors duration-500',
                        isDark ? 'text-[#22D3EE]' : 'text-[#0891B2]'
                      )}
                    >
                      LOCKED
                ...
                <div className="p-[18px] flex flex-col gap-4">
                  ...
                  <div className="flex items-baseline gap-1.5">
                    ...
                    >
                      {(1845.2 * metricMultiplier).toLocaleString('en-US', {
                        minimumFractionDigits: 1,
                        maximumFractionDigits: 1,
                      })}
                    </span>
                  ...
                  <div
                    onClick={() =>
                      triggerTrace('Scope 2 Location-Based', [
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        'font-mono text-[9px] transition-colors duration-500 truncate',
                        isDark ? 'text-[#9CA3AF]' : 'text-[#4B5563]'
                      )}
                    >
                ...
                <div className="p-[18px] pt-0 flex items-center justify-between mt-auto">
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() =>
                        triggerTrace('Scope 2 Grid Electricity', [
              ...
              >
                ...
                <div className="p-[18px] flex flex-col gap-4.5">
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        'font-bold text-[10px] animate-pulse-slow transition-colors duration-500',
                    ...
                    <div
                      className={cn(
                        ...
                        isDark
                          ? 'bg-[#22D3EE] text-[#0F172A] shadow-cyan-500/10'
                          : 'bg-[#0891B2] text-white shadow-cyan-600/10'
                      )}
                    >
                      WEAVE
                    </div>
                  ...
                  <div
                    className={cn(
                      ...
                      isDark ? 'bg-[#0F172A] border-gray-800/60' : 'bg-[#E0F2FE]/70 border-sky-100'
                    )}
                  >
                    <span
                      className={cn(
                ...
                <div className="p-[18px] pt-0 flex items-center justify-between mt-auto">
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() =>
                        triggerTrace('Weave Engine Core', [
              ...
              >
                ...
                <div className="p-[18px] flex flex-col gap-4">
                  ...
                  >
                    ...
                    >
                      <span className="text-emerald-500 text-xs leading-none">✓</span> Alignment:
                      GHG Protocol Standard V4
                    </span>
                  </div>
                ...
                <div className="p-[18px] pt-0 flex items-center justify-between mt-auto">
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() =>
                        triggerTrace('Formula Consensus Hub', [
              ...
              >
                ...
                <div className="p-[18px] flex flex-col gap-4">
                  ...
                  <div
                    className={cn(
                      ...
                      isDark
                        ? 'bg-[#020617] border-[#06B6D4]/40'
                        : 'bg-sky-50/50 border-[#0891B2]/25'
                    )}
                  >
                    <span
                      className={cn(
                    ...
                    <span
                      className={cn(
                        'text-[11px] font-mono tracking-wide transition-colors duration-500',
                        isDark ? 'text-[#F9FAFB]' : 'text-[#111827]'
                      )}
                    >
                      0x3F8B...E1D2_SEAL
                ...
                <div className="p-[18px] pt-0 flex items-center justify-between mt-auto">
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() =>
                        triggerTrace('Cold Crystal Vault', [
              ...
              >
                ...
                <div className="p-[18px] flex flex-col gap-4">
                  ...
                  <div className="flex items-baseline gap-2.5">
                    <span
                      className={cn(
                        'text-[32px] font-black tracking-tight leading-none transition-colors duration-500',
                        isDark ? 'text-[#F9FAFB]' : 'text-[#111827]'
                      )}
                    >
                      99.98%
                    ...
                    <span
                      className={cn(
                        'text-[11px] font-bold tracking-wide transition-colors duration-500',
                        isDark ? 'text-[#22D3EE]' : 'text-[#0891B2]'
                      )}
                    >
                      INTEGRITY RATE
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    <div className="flex items-center justify-between text-[11px]">
                      ...
                      <span
                        className={cn(
                          'font-bold font-mono transition-colors duration-500',
                          isDark ? 'text-[#22D3EE]' : 'text-[#0891B2]'
                        )}
                      >
                        ✓ VERIFIED
                ...
                <div className="p-[18px] pt-0 flex items-center justify-between mt-auto">
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() =>
                        triggerTrace('Platform Integrity Index', [
          ...
          <div
            className={cn(
              ...
              isDark ? 'bg-[#111827]/70 border-gray-800/40 -md ' : ' border-gray-200/50 -md '
            )}
          >
            <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-800/10 dark:border-gray-700/10">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xs font-bold font-mono tracking-wider">
                  OMNI-WEAVE DIRECTORY CRYPTO-TRACES
                </h3>
              </div>
            ...
            >
              {activeTrace ? (
                <>
                  ...
                  <p className="text-[#34D399] dark:text-[#34D399] font-bold">
                    &gt;&gt; VERIFIED BY MULTI-AGENT SWARM CONSENSUS ORACLE.
                  </p>
                </>
              ) : (
                customLogs.map((log, index) => (
                  <p
                    key={index}
                    className={cn(index === 0 && 'font-semibold text-gray-100 dark:text-gray-900')}
                  >
                    {log}
                  </p>
                ))
        ...
        <footer
          className={cn(
            ...
            isDark
              ? 'border-gray-800/40 text-gray-500 bg-[#0B0F19]/20'
          ...
          >
            <div className="flex items-center justify-between pb-3 border-b border-gray-800/10 dark:border-gray-700/10">
              <h4 className="font-bold text-sm tracking-wide flex items-center gap-2">
                <FileCheck
                  className={cn('w-4.5 h-4.5', isDark ? 'text-[#34D399]' : 'text-[#15803D]')}
                />
                {formulaModal.title}
              </h4>
              <button
            ...
            <div className="flex flex-col gap-3">
              ...
              <div
                className={cn(
                  ...
                  isDark
                    ? 'bg-[#020617] border-gray-800/60 text-[#34D399]'
                    : 'bg-gray-50 border-gray-200 text-[#15803D]'
                )}
              >
              ...
              <span
                className={cn('text-xs font-bold mt-2', isDark ? 'text-gray-400' : 'text-gray-500')}
              >
            ...
            <div className="flex items-center justify-end gap-2 pt-3 border-t border-gray-800/10 dark:border-gray-700/10">
              <button
                onClick={() => {
                  setCustomLogs((prev) => [
                    `>> [FORMULA_ACTION] Copied formula expression to secure clipboard.`,
                    ...prev.slice(0, 5),
                  ]);
                ...
                className={cn(
                  ...
                  isDark
                    ...
                    : 'bg-[#0891B2] hover:bg-[#0369A1] text-white'
                )}
              >
                Copy Formula
              </button>
              <button
                ...
                className={cn(
                  ...
                  isDark
                    ? 'bg-transparent border-gray-800 hover:bg-gray-800 text-gray-300'
                    : 'bg-transparent border-gray-200 hover:bg-gray-100 text-gray-600'
                )}
              >
                Dismiss
              </button>
