...
const documents = [
  ...
  { id: 'bench-global-2024', title: 'Global Benchmark: Uniqlo Sustainable Supply Chain', description: 'Uniqlo and Fast Retailing lead in textile sustainability with recycling programs and carbon-neutral logistics.', category: 'case-study', esg_category: 'Social', tags: ['International', 'Benchmark', 'Textile', 'Supply Chain', 'Recycling'], source: 'https://www.uniqlo.com/', published_date: '2024-01-01' },
