...
# Write question-bank.ts
with open(os.path.join(OUT, "question-bank.ts"), "w", encoding="utf-8") as f:
...
with open(os.path.join(OUT, "answer-database.ts"), "w", encoding="utf-8") as f:
