module.exports=[918622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},556704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},832319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},324725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},193695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},442315,(e,t,r)=>{"use strict";t.exports=e.r(918622)},256104,e=>{"use strict";class t{tokenId;tokenSecret;companyId;projectId;baseUrl;constructor(e){this.tokenId=e?.tokenId||process.env.BLUE_CC_TOKEN_ID||"",this.tokenSecret=e?.tokenSecret||process.env.BLUE_CC_API_KEY||"",this.companyId=e?.companyId||process.env.BLUE_CC_COMPANY_ID||"",this.projectId=e?.projectId||process.env.BLUE_CC_PROJECT_ID,this.baseUrl=e?.baseUrl||"https://api.blue.cc/graphql"}async request(e,t){if(!this.tokenId||!this.tokenSecret)return{success:!1,error:"Blue.cc auth incomplete: BLUE_CC_TOKEN_ID / BLUE_CC_API_KEY required"};let r={"Content-Type":"application/json","X-Bloo-Token-ID":this.tokenId,"X-Bloo-Token-Secret":this.tokenSecret,"X-Bloo-Company-ID":this.companyId};this.projectId&&(r["X-Bloo-Project-ID"]=this.projectId);try{let s=await fetch(this.baseUrl,{method:"POST",headers:r,body:JSON.stringify({query:e,variables:t})});if(!s.ok){let e=await s.text();return{success:!1,error:`HTTP ${s.status}: ${e}`}}let a=await s.json();if(a.errors){let e=a.errors.map(e=>e.message).join("; ");return{success:!1,error:`GraphQL Error: ${e}`}}return{success:!0,data:a.data}}catch(e){return{success:!1,error:`Request Failed: ${e.message}`}}}async getCurrentUser(){return this.request("query { currentUser { id email fullName companies { id name slug } } }")}async getOrganization(){return this.request("query { company { id name slug } }")}async listProjects(){let e=`
    ...
    `,a=await this.request(s,{type:e,filter:{companyIds:[r]}});return a.success&&a.data?.todoGroups?{success:!0,data:{items:a.data.todoGroups.items,totalItems:a.data.todoGroups.pageInfo?.totalItems||0}}:a}}new t,e.s(["BlueCcClient",0,t,"blueCC",0,{deployAgent:async(e,t)=>({deployment_id:`mock-${Date.now()}`}),getSystemStatus:async()=>({healthy:!0,active_nodes:3,last_sync:new Date().toISOString()}),listResources:async()=>[]}])},545336,e=>{"use strict";var t=e.i(747909),r=e.i(174017),s=e.i(996250),a=e.i(759756),o=e.i(561916),i=e.i(174677),n=e.i(869741),d=e.i(316795),u=e.i(487718),c=e.i(995169),l=e.i(47587),p=e.i(666012),h=e.i(570101),m=e.i(626937),y=e.i(10372),g=e.i(193695);e.i(52474);var R=e.i(257297),C=e.i(89171),x=e.i(256104);async function f(e){try{let{searchParams:t}=new URL(e.url),r=t.get("listId")||void 0,s=new x.BlueCcClient,a=await s.listRecords(r);if(!a.success)return C.NextResponse.json({ok:!1,error:a.error},{status:502});return C.NextResponse.json({ok:!0,records:a.data?.items||[],total:a.data?.totalItems||0})}catch(e){return C.NextResponse.json({ok:!1,error:e.message},{status:500})}}async function I(e){try{let{title:t,listId:r,customFields:s}=await e.json();if(!t)return C.NextResponse.json({ok:!1,error:"title is required"},{status:400});let a=new x.BlueCcClient,o=await a.createRecord(t,r,s);if(!o.success)return C.NextResponse.json({ok:!1,error:o.error},{status:502});return C.NextResponse.json({ok:!0,record:o.data},{status:201})}catch(e){return C.NextResponse.json({ok:!1,error:e.message},{status:500})}}e.s(["GET",0,f,"POST",0,I],884484);var v=e.i(884484);let w=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/bluecc/records/route",pathname:"/api/bluecc/records",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/bluecc/records/route.ts",nextConfigOutput:"",userland:v,...{}}),{workAsyncStorage:E,workUnitAsyncStorage:T,serverHooks:j}=w;async function q(e,t,s){s.requestMeta&&(0,a.setRequestMeta)(e,s.requestMeta),w.isDev&&(0,a.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let C="/api/bluecc/records/route";C=C.replace(/\/index$/,"")||"/";let x=await w.prepare(e,t,{srcPage:C,multiZoneDraftMode:!1});if(!x)return t.statusCode=400,t.end("Bad Request"),null==s.waitUntil||s.waitUntil.call(s,Promise.resolve()),null;let{buildId:f,deploymentId:I,params:v,nextConfig:E,parsedUrl:T,isDraftMode:j,prerenderManifest:q,routerServerContext:A,isOnDemandRevalidate:k,revalidateOnlyGenerated:_,resolvedPathname:N,clientReferenceManifest:S,serverActionsManifest:b}=x,P=(0,n.normalizeAppPath)(C),L=!!(q.dynamicRoutes[P]||q.routes[N]),$=async()=>((null==A?void 0:A.render404)?await A.render404(e,t,T,!1):t.end("This page could not be found"),null);if(L&&!j){let e=!!q.routes[N],t=q.dynamicRoutes[P];if(t&&!1===t.fallback&&!e){if(E.adapterPath)return await $();throw new g.NoFallbackError}}let U=null;!L||w.isDev||j||(U="/index"===(U=N)?"/":U);let O=!0===w.isDev||!L,D=L&&!O;b&&S&&(0,i.setManifestsSingleton)({page:C,clientReferenceManifest:S,serverActionsManifest:b});let B=e.method||"GET",F=(0,o.getTracer)(),H=F.getActiveScopeSpan(),M=!!(null==A?void 0:A.isWrappedByNextServer),G=!!(0,a.getRequestMeta)(e,"minimalMode"),K=(0,a.getRequestMeta)(e,"incrementalCache")||await w.getIncrementalCache(e,E,q,G);null==K||K.resetRequestCache(),globalThis.__incrementalCache=K;let W={params:v,previewProps:q.preview,renderOpts:{experimental:{authInterrupts:!!E.experimental.authInterrupts},cacheComponents:!!E.cacheComponents,supportsDynamicResponse:O,incrementalCache:K,cacheLifeProfiles:E.cacheLife,waitUntil:s.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,s,a)=>w.onRequestError(e,t,s,a,A)},sharedContext:{buildId:f,deploymentId:I}},X=new d.NodeNextRequest(e),V=new d.NodeNextResponse(t),Y=u.NextRequestAdapter.fromNodeNextRequest(X,(0,u.signalFromNodeResponse)(t));try{let a,i=async e=>w.handle(Y,W).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=F.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let s=r.get("next.route");if(s){let t=`${B} ${s}`;e.setAttributes({"next.route":s,"http.route":s,"next.span_name":t}),e.updateName(t),a&&a!==e&&(a.setAttribute("http.route",s),a.updateName(t))}else e.updateName(`${B} ${C}`)}),n=async a=>{var o,n;let d=async({previousCacheEntry:r})=>{try{if(!G&&k&&_&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let o=await i(a);e.fetchMetrics=W.renderOpts.fetchMetrics;let n=W.renderOpts.pendingWaitUntil;n&&s.waitUntil&&(s.waitUntil(n),n=void 0);let d=W.renderOpts.collectedTags;if(!L)return await (0,p.sendResponse)(X,V,o,W.renderOpts.pendingWaitUntil),null;{let e=await o.blob(),t=(0,h.toNodeOutgoingHttpHeaders)(o.headers);d&&(t[y.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==W.renderOpts.collectedRevalidate&&!(W.renderOpts.collectedRevalidate>=y.INFINITE_CACHE)&&W.renderOpts.collectedRevalidate,s=void 0===W.renderOpts.collectedExpire||W.renderOpts.collectedExpire>=y.INFINITE_CACHE?void 0:W.renderOpts.collectedExpire;return{value:{kind:R.CachedRouteKind.APP_ROUTE,status:o.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:s}}}}catch(t){throw(null==r?void 0:r.isStale)&&await w.onRequestError(e,t,{routerKind:"App Router",routePath:C,routeType:"route",revalidateReason:(0,l.getRevalidateReason)({isStaticGeneration:D,isOnDemandRevalidate:k})},!1,A),t}},u=await w.handleResponse({req:e,nextConfig:E,cacheKey:U,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:q,isRoutePPREnabled:!1,isOnDemandRevalidate:k,revalidateOnlyGenerated:_,responseGenerator:d,waitUntil:s.waitUntil,isMinimalMode:G});if(!L)return null;if((null==u||null==(o=u.value)?void 0:o.kind)!==R.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==u||null==(n=u.value)?void 0:n.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});G||t.setHeader("x-nextjs-cache",k?"REVALIDATED":u.isMiss?"MISS":u.isStale?"STALE":"HIT"),j&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let c=(0,h.fromNodeOutgoingHttpHeaders)(u.value.headers);return G&&L||c.delete(y.NEXT_CACHE_TAGS_HEADER),!u.cacheControl||t.getHeader("Cache-Control")||c.get("Cache-Control")||c.set("Cache-Control",(0,m.getCacheControlHeader)(u.cacheControl)),await (0,p.sendResponse)(X,V,new Response(u.value.body,{headers:c,status:u.value.status||200})),null};M&&H?await n(H):(a=F.getActiveScopeSpan(),await F.withPropagatedContext(e.headers,()=>F.trace(c.BaseServerSpan.handleRequest,{spanName:`${B} ${C}`,kind:o.SpanKind.SERVER,attributes:{"http.method":B,"http.target":e.url}},n),void 0,!M))}catch(t){if(t instanceof g.NoFallbackError||await w.onRequestError(e,t,{routerKind:"App Router",routePath:P,routeType:"route",revalidateReason:(0,l.getRevalidateReason)({isStaticGeneration:D,isOnDemandRevalidate:k})},!1,A),L)throw t;return await (0,p.sendResponse)(X,V,new Response(null,{status:500})),null}}e.s(["handler",0,q,"patchFetch",0,function(){return(0,s.patchFetch)({workAsyncStorage:E,workUnitAsyncStorage:T})},"routeModule",0,w,"serverHooks",0,j,"workAsyncStorage",0,E,"workUnitAsyncStorage",0,T],545336)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__15k3ez5._.js.map