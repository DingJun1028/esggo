    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-[#F8FAFD] flex items-center justify-center p-6">
          <BrandCard
            padding="lg"
            className="max-w-md w-full text-center space-y-6 shadow-extreme border-white/60 rounded-[3rem]"
          >
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-black text-[#003262] uppercase tracking-tight">
                系統異常中斷
              </h2>
