    ...
    return (
      <div
        ...
        className={cn(
          ...
          // 發光效果（用於重要卡片）
          glow &&
            'before:absolute before:inset-0 before:-z-10 before:rounded-card before:bg-gradient-to-r before:from-berkeley-blue/5 before:to-verified/5 before:blur-2xl',
    ...
    <div className={cn('flex items-start justify-between mb-6', className)}>
      <div className="space-y-1">
        <div className="flex items-center gap-3">
          ...
          {title && (
            <h3 className="text-lg font-black text-berkeley-blue uppercase tracking-tight">
              {title}
            </h3>
          )}
        </div>
...
export function CardTitle({
  ...
  return (
    <h3 className={cn('text-lg font-black text-berkeley-blue tracking-tight', className)}>
      {children}
    </h3>
  );
}
