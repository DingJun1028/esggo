      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            {currentValue && (
              <div className="bg-[#EBF2FA] rounded-3xl p-6 border border-blue-100/50">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-black text-[#003262] font-mono">
                    {currentValue}
                  </span>
            ...
            <div>
              <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-6 px-1">
                溯源路徑 (Provenance Path)
              </h3>
              <div className="space-y-0 relative">
                ...
                {steps.map((step, idx) => (
                  <div key={step.id} className="relative flex gap-6 pb-10 last:pb-0">
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center z-10 border-4 border-white shadow-sm ${
                        step.type === 'source'
                    ...
                    <div className="flex-1 pt-1">
                      ...
                      <div className="flex items-center gap-2 mt-3">
                        ...
                        {idx === 0 && (
                          <BrandBadge variant="outline" size="xs" className="text-[8px]">
                            ROOT_ORIGIN
                          </BrandBadge>
                        )}
                      </div>
          ...
          <footer className="p-6 border-t border-slate-100 bg-slate-50/50">
            <BrandButton variant="primary" fullWidth onClick={onClose}>
              確認溯源無誤
            </BrandButton>
