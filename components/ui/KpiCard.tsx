  ...
  return (
    <>
      ...
      >
        ...
        <div className="text-[11px] text-[#9ca3af] font-semibold mb-1 uppercase tracking-wide">
          {label}
        </div>
        <div className="flex items-baseline gap-1.5">
          <span className="text-[26px] font-extrabold leading-none" style={{ color }}>
            {value}
          </span>
          ...
          >
            <div className="flex justify-between items-center mb-5">
              ...
              <button
                aria-label="關閉說明"
                onClick={() => setShowFormula(false)}
                className="w-7 h-7 rounded-full bg-[#f3f4f6] flex items-center justify-center hover:bg-[#e5e7eb] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400"
              >
            ...
            {formula && (
              <div className="mb-4">
                <div className="text-[11px] font-semibold text-[#9ca3af] uppercase tracking-wide mb-2">
                  計算公式
                </div>
