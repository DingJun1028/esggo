          ...
          <div className="flex-1">
            {omniHeart && omniHeart.fiveTState && (
              <div className="flex items-center space-x-2 text-[10px] font-mono opacity-80">
                ...
                <span
                  className={omniHeart.fiveTState.tangible ? 'text-[#63a6b0]' : 'text-slate-500'}
                >
                  Tan
                </span>
                <span
                  className={omniHeart.fiveTState.traceable ? 'text-[#63a6b0]' : 'text-slate-500'}
                >
                  Tra
                </span>
                <span
                  className={omniHeart.fiveTState.trackable ? 'text-[#63a6b0]' : 'text-slate-500'}
                >
                  Trk
                </span>
                <span
                  className={omniHeart.fiveTState.transparent ? 'text-[#63a6b0]' : 'text-slate-500'}
                >
                  Trp
                </span>
                <span
                  className={
                    omniHeart.fiveTState.trustworthy ? 'text-[#ffd700] font-bold' : 'text-slate-500'
                  }
                >
                  Tru
                </span>
