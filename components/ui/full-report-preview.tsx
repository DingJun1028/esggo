    ...
    >
      ...
      <div className="p-8 sm:p-12 relative z-10">
        ...
        <div className="flex justify-between items-start mb-12">
          ...
          <button onClick={onClose} className="p-2 hover:bg-white/10 rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500" aria-label="關閉報告" title="關閉報告">
