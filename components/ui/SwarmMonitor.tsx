    ...
    >
      <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-slate-800/5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="text-[10px] font-black text-berkeley-blue uppercase tracking-[0.2em]">
              Omni-Swarm Monitor
            </h4>
            <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">
              Real-time Orchestration • v1.1
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <BrandBadge
            variant="outline"
            size="xs"
            className="text-berkeley-blue border-berkeley-blue/20"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {(agents.length > 0 ? agents : []).map((agent) => {
            ...
            return (
              <div
                key={agent.id}
                className="p-3 rounded-xl bg-white border border-slate-100 shadow-sm flex flex-row sm:flex-col items-center text-left sm:text-center gap-4 sm:gap-2 transition-all hover:border-blue-200"
              >
                <div
                  className={cn(
                ...
                <div className="min-w-0">
                  <p className="text-[9px] font-black text-slate-800 uppercase truncate w-full">
              ...
              {tasks.slice(0, 3).map((task) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[10px] font-bold text-berkeley-blue truncate">
                      {task.title}
                    </p>
        ...
        <div className="p-4 bg-berkeley-blue rounded-2xl text-white relative overflow-hidden">
          <div className="relative z-10 space-y-3">
            ...
            <p className="text-[9px] font-bold opacity-60 uppercase">
              Cluster: blue-cluster-omni • asia-east1
            </p>
          </div>
      ...
      <div className="p-4 bg-slate-50 border-t border-slate-100">
        <BrandButton
          ...
          size="xs"
          fullWidth
          className="h-8 text-[9px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-berkeley-blue"
        >
          進入蜂群指揮中心
        </BrandButton>
      </div>
