      ...
      className={cn(
        ...
        fullWidth && 'w-full',
        {
          'bg-neutral-900 text-white hover:bg-neutral-800 focus:ring-neutral-500':
            variant === 'primary',
          'bg-neutral-100 text-neutral-700 hover:bg-neutral-200 border border-neutral-200 focus:ring-neutral-300':
            variant === 'secondary' || variant === 'outline',
          'bg-transparent text-neutral-600 hover:bg-neutral-50 focus:ring-neutral-200':
            variant === 'ghost',
