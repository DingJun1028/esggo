...
export function MaterialityMatrixView() {
  ...
  // Memoize filtered and sorted topics to prevent unnecessary array operations on re-renders
  ...
  const sortedTopics = useMemo(() => {
    return [...filteredTopics].sort((a, b) =>
      (b.business_impact + b.stakeholder_importance) - (a.business_impact + a.stakeholder_importance)
    );
  }, [filteredTopics]);
