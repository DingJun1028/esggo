...
interface LandingContentProps {
  trackerNode?: React.ReactNode;
}

export default function LandingContent({ trackerNode }: LandingContentProps) {
            ...
            switch (data.stage) {
              ...
              case 'HEALING_STARTED':
                ...
                if (data.message) {
                  ...
                  setHealingLogs((prev: LogEntry[]) => [
                    ...prev,
                    { time: getTime(), level: 'error', text: data.message },
                  ]);
                  ...
                  setTimeout(() => {
                    setHealingLogs((prev: LogEntry[]) => [
                      ...prev,
                      {
                        time: getTime(),
                        level: 'heal',
                        text: 'OmniAgent 已從 ERP 系統提取缺漏的 350 噸碳排憑證...',
                      },
                    ]);
                  }, 800);
                  ...
                  setTimeout(() => {
                    setHealingLogs((prev: LogEntry[]) => [
                      ...prev,
                      {
                        time: getTime(),
                        level: 'zkp',
                        text: '重新產生 Pedersen 承諾並同態加總，驗證通過。',
                      },
                    ]);
                  }, 1800);
                }
                break;
              case 'SEALING_5T':
                setHealingStatus((prev: NodeStatus | undefined) =>
                  prev && prev !== 'idle' ? 'success' : prev
                );
      ...
      >
        ...
        >
          ...
          <div className="flex gap-4 mb-2 relative z-10">
            <div className="flex items-center gap-3 px-5 py-2 rounded-full border border-cyan-500/20 -md shadow-inner">
              <BrandStatusDot status="active" pulse size="sm" />
              <span className="text-[10px] font-black tracking-[0.3em] text-cyan-400 uppercase">
                OmniAgent_Live
              </span>
            </div>
            <div className="flex items-center gap-3 px-5 py-2 rounded-full border border-emerald-500/20 -md shadow-inner">
          ...
          <p className="mt-4 text-lg md:text-xl lg:text-2xl text-slate-300 max-w-3xl font-medium leading-relaxed tracking-tight relative z-10">
            Sovereign Governance Operating System. <br />由{' '}
            <span className="text-white font-bold drop-shadow-md">OmniAgent</span>{' '}
            總指揮官全域調度，承載{' '}
            <span className="text-[#FDB515] font-bold drop-shadow-md">JunAiKey</span> 無上意志。
            <br />
        ...
        >
          <Link href="/dashboard" className="group h-full">
            <BrandCard
              ...
              hover
              padding="lg"
              className="h-full flex flex-col justify-between text-left group-hover:border-cyan-500/40 transition-colors"
            >
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed">
                    進入 Liquid Glass Premium 儀表板，體驗 T3 Tangible 全感官治理躍遷。
                  </p>
                </div>
              </div>
          ...
          <Link href="/map" className="group h-full">
            <BrandCard
              ...
              hover
              padding="lg"
              className="h-full flex flex-col justify-between text-left group-hover:border-indigo-500/40 transition-colors"
            >
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed">
                    鳥瞰全端數據演進脈絡，精準映射 5T 誠信協議與 GRI 治理缺口。
                  </p>
                </div>
              </div>
          ...
          <Link href="/atomic" className="group h-full">
            <BrandCard
              ...
              hover
              padding="lg"
              className="h-full flex flex-col justify-between text-left group-hover:border-emerald-500/40 transition-colors"
            >
              <div className="space-y-6">
          ...
          <Link href="/omni-shards" className="group h-full">
            <BrandCard
              ...
              hover
              padding="lg"
              className="h-full flex flex-col justify-between text-left group-hover:border-purple-500/40 transition-colors"
            >
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed">
                    進入 OmniAgent 記憶中樞，將對話殘影淬鍊為具備心法的高階技能奧義。
                  </p>
                </div>
              </div>
