  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 bg-[#020617] rounded-2xl border border-cyan-900/50 shadow-2xl relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 flex flex-col gap-6">
        ...
        <div className="w-full border border-cyan-800/40 rounded-xl -md overflow-hidden relative">
            ...
            <div className="w-full text-center py-12 text-slate-500 border-t border-dashed border-cyan-800/40">
              <div className="flex flex-col items-center gap-3">
                ...
                <span className="text-sm">
                  尚未萃取任何記憶碎片，點擊右上角按鈕從對話中擷取 (5T 協議等待中)
                </span>
              </div>
            </div>
          )}
        ...
        {ultimate && (
          <div className="mt-6 p-6 rounded-2xl border-2 border-emerald-500/40 bg-gradient-to-br from-emerald-950/40 to-slate-900/60 shadow-[0_0_30px_rgba(16,185,129,0.2)] overflow-hidden relative">
