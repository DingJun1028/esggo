...
export default function OmniJulesPassiveGuard() {
  ...
  return (
    <>
      {healingAlert && (
        <div className="fixed bottom-6 right-6 z-[10000] flex items-center gap-3 bg-slate-900/90 border border-red-500/50 rounded-xl p-4 shadow-[0_0_30px_rgba(245,34,45,0.3)]">
