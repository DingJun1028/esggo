        ...
        <div className="flex items-center gap-6 min-w-0">
          ...
          <div className="flex items-center gap-4 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-2xl font-black text-[#003262] tracking-tighter truncate uppercase">
                {config.title}
              </h1>
              {config.subtitle && (
          ...
          <div className="flex items-center gap-2">
            <BrandBadge
              variant="outline"
              size="sm"
              className="bg-[#FDB515]/5 text-[#003262] border-[#FDB515]/20 font-black tracking-widest px-3"
            >
              ...
              <BrandCard variant="glass" hover padding="sm" className="group">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-baseline gap-1.5">
                    <span
                      className="text-2xl font-black text-[#003262] font-mono tracking-tighter"
                      style={{ color: k.color }}
                    >
                      {k.value}
                    </span>
          ...
          .map((section, idx) => (
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between p-6 border-b border-slate-100/40">
                  <div className="flex items-center gap-4 min-w-0">
                    {section.icon && (
                    ...
                    <div className="min-w-0">
                      <p className="text-base font-black text-[#003262] tracking-tight uppercase">
                        {section.title}
                      </p>
                      {section.subtitle && (
                        <p className="text-[9px] text-slate-400 font-black uppercase tracking-[0.3em] mt-0.5 truncate">
                          {section.subtitle}
                        </p>
                      )}
                    </div>
                  ...
                  <div className="flex items-center gap-2">
                    {section.actions?.map((a) => (
                      <BrandButton
                        ...
                        variant="secondary"
                        size="xs"
                        className="w-9 h-9 p-0 rounded-xl hover:"
                        onClick={a.onClick}
                      >
