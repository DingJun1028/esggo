      ...
      >
          ...
          <div className="flex items-center gap-6 relative z-10">
            ...
            <div>
              <div className="flex items-center gap-3">
                <h2 className="text-2xl font-black text-berkeley-blue uppercase tracking-tight">
                  OmniAgent Kernel
                </h2>
                <Badge
                  variant="verified"
                  className="px-3 py-1 font-black tracking-widest text-[9px]"
                >
                  v8.5.2-STABLE
                </Badge>
              </div>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] mt-1">
                System Health Index:{' '}
                <span className="text-berkeley-blue">Rs {(rs * 100).toFixed(1)}%</span>
              </p>
            </div>
          </div>
          <Button
              ...
              {[
                ...
                >
                  <span
                    className={cn(
                      'transition-colors',
                      activeTab === t.id ? 'text-california-gold' : 'group-hover:text-berkeley-blue'
                    )}
                  >
                    {t.icon}
                  </span>
              ...
              <Card className="p-6 bg-berkeley-blue text-white border-none shadow-xl relative overflow-hidden">
                <div className="relative z-10 space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-base font-black font-mono text-california-gold">
                      {(rs * 100).toFixed(1)}%
                    </span>
                  </div>
              ...
              {activeTab === 'kernel' && (
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <Card className="p-8 border-white/80">
                  ...
                  <section className="space-y-6 pt-6">
                    ...
                    <div className="grid gap-4">
                      {[
                        {
                          label: '5T 實時同步 (Autosync)',
                          desc: '在每次寫入數據時自動進行 SHA-256 誠信簽署與聖碑同步。',
                          enabled: true,
                        },
                        {
                          label: '自癒與蜂群模式 (Self-Healing)',
                          desc: '當 AI 檢測到數據偏差時自動發起 Swarm 委派校準。',
                          enabled: true,
                        },
                        {
                          label: '跨鏈實證錨定 (Public Anchor)',
                          desc: '將 Master Seals 同步至公有確信鏈以實現全域透明度。',
                          enabled: false,
                        },
                      ].map((item, i) => (
                        <div
              ...
              {activeTab === 'trust' && (
                ...
                >
                  <div className="flex items-center justify-between px-2">
                    <div>
                      <h4 className="text-2xl font-black text-berkeley-blue tracking-tight">
                        5T 誠信協議驗證
                      </h4>
                      <p className="text-sm text-slate-400 font-medium mt-1">
                        實時測試 OmniInfoCrystal 的封印與校驗流程。
                      </p>
                    </div>
                    <Button
                      variant="primary"
                  ...
                  <div className="grid grid-cols-1 gap-8">
                      ...
                      <Card className="p-10 bg-berkeley-blue/5 border-berkeley-blue/10 relative overflow-hidden">
                        <div className="flex items-center justify-between mb-8">
                          <div className="flex items-center gap-5">
                            ...
                            <div>
                              ...
                              <code className="text-sm font-black text-berkeley-blue uppercase">
                                {lastSeal.uuid}
                              </code>
                            </div>
                          </div>
                        ...
                        <div className="grid grid-cols-2 gap-12 mb-10 border-y border-slate-100 py-8">
                          <div>
                            ...
                            <p className="text-xl font-black text-berkeley-blue font-mono">
                              {lastSeal.impact_metric}
                            </p>
                          </div>
                          <div>
                            <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] mb-3">
                              Hash Lock (T4 Integrity)
                            </p>
                        ...
                        <Bot
                          size={200}
                          className="absolute -bottom-20 -right-20 text-berkeley-blue/5 rotate-12 pointer-events-none"
                        />
                      </Card>
                    ) : (
                    ...
                    <section className="space-y-6">
                      <h4 className="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em] ml-2">
                        OmniInfoCrystal 5T States
                      </h4>
                      <div className="grid grid-cols-5 gap-4">
                        {['Traceable', 'Transparent', 'Tangible', 'Trackable', 'Trustworthy'].map(
                          (gate, i) => (
                            <Card
                              key={i}
                              className={cn(
                                ...
                                lastSeal
                                  ...
                                  : 'bg-slate-50/50 border-transparent opacity-30 scale-95'
                              )}
                            >
                              <div
                                className={cn(
        ...
        <footer className="px-10 py-8 border-t border-slate-100/50 bg-slate-50/50 flex items-center justify-between sticky bottom-0 z-10">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="font-black text-[10px] uppercase tracking-widest h-10 px-8 hover:bg-white rounded-xl border-slate-200"
            onClick={onClose}
          >
