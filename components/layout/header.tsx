      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 p-2.5 hover:bg-primary/5 rounded-xl transition-colors text-text-muted hover:text-primary group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-current"
        ...
        <div className="relative">
          <button
            ...
            className="p-2.5 hover:bg-primary/5 rounded-xl transition-colors relative flex items-center justify-center group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-current"
          >
            <Bell className="w-5 h-5 text-text-muted group-hover:text-primary transition-colors" aria-hidden="true" />
            <span className="absolute top-2.5 right-2.5 w-1.5 h-1.5 bg-status-lethal rounded-full" aria-hidden="true" />
          </button>
