...
import {
  ...
  GraduationCap, Award, Heart, Sparkles, Target, Layers,
  Database, Activity, CheckCircle2, AlertCircle, Star
} from 'lucide-react';
...
export const NAV_STAGES: NavStage[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '報告撰寫', path: '/sustain-write', icon: FileText },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '通知', path: '/notifications', icon: Activity },
  ...
  },
  {
    ...
    items: [
      { name: '價值階梯', path: '/value-ladder', icon: TrendingUp, isPro: true },
      { name: '價值等級', path: '/value-levels', icon: TrendingUp, isPro: true },
      { name: '價值路徑', path: '/value-path', icon: TrendingUp, isPro: true },
