...
export const ThemeContext = {
  ...
  // 提供全域配置映射
  themes: {
    Atlantic: AtlanticTheme,
    Berkeley: BerkeleyTheme,
    Mindful: MindfulTheme,
    Fusion: FusionTheme,
  },
};
