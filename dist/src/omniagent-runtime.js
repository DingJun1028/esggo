...
OmniAgent: Received query - "${userQuery}"`);
    ...
    try {
        ...
        if (userQuery.includes("analyze ESG data")) {
            ...
            const analysisResult = await omniAgentBus.invokeSkillAction('esg-data-advisor', 'analyzeESGData', analysisInput, currentTaskContext);
            ...
            const complianceResult = await omniAgentBus.invokeSkillAction('esg-data-advisor', 'checkGRICompliance', complianceInput, currentTaskContext);
            ...
            const promptResult = await omniAgentBus.invokeSkillAction('gemma-dev', 'generatePrompt', promptInput, currentTaskContext);
