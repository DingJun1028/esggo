...
// 管理員客戶端（繞過 RLS）
exports.supabaseAdmin = (0, supabase_js_1.createClient)(SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY || SUPABASE_ANON_KEY, {
    auth: {
        persistSession: false,
...
async function testConnection() {
    try {
        const { error } = await exports.supabase.from('evidences').select('id').limit(1);
        return !error;
    }
    catch {
        return false;
