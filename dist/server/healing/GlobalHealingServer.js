...
exports.globalHealingService = exports.GlobalHealingService = void 0;
const global_healing_1 = require("../../../lib/omni-space/global-healing");
 ...
 */
class GlobalHealingService {
    constructor(eventStore, level = 'LV2_AUTO_HEAL') {
        this.registeredNodesMap = new Map();
        this.eventStore = eventStore || new event_store_1.EventStore();
        this.healer = new global_healing_1.GlobalHealing(this.eventStore, level);
    }
    /**
     ...
     */
    async healCard(card, level = 'LV2_AUTO_HEAL') {
...
exports.GlobalHealingService = GlobalHealingService;
// 匯出預設單例以供系統各模組無縫對接
exports.globalHealingService = new GlobalHealingService();
//# sourceMappingURL=GlobalHealingServer.js.map