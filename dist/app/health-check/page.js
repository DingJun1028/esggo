...
import { Stethoscope, Search, Plus, ShieldCheck, Activity, Brain, Lock, Loader2 } from 'lucide-react';
export default function HealthCheckPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const res = await fetch('/api/metrics/health-check', { cache: 'no-store' });
            if (res.ok) {
