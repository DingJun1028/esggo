...
import { History, Search, Plus, ShieldCheck, Activity, Brain, Lock, Loader2 } from 'lucide-react';
    ...
    const handleSeal = async (id) => {
        ...
        try {
            const response = await fetch('/api/vault/seal', {
                ...
                body: JSON.stringify({
                    evidence: { table: 'audit-log', recordId: id, timestamp: Date.now() },
                    type: '5t-seal'
                })
            });
