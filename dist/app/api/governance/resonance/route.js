...
export async function GET() {
    try {
        ...
        const results = governanceEngine.calculateResonance(topics.map(t => ({
            id: t.id,
            label: t.label,
            category: t.category,
        ...
        return NextResponse.json(createErrorResponse('RESONANCE_FAILED', error.message || 'Resonance calculation failed'), { status: 500 });
    }
}
