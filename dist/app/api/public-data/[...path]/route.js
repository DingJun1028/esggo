...
import { proxyToNCBPublic, getRlsPolicies, extractTableFromPath, allowsPublicRead, allowsPublicWrite, requiresOwnerScope, } from "@/lib/ncb-utils";
const json = (body, status = 200) => new NextResponse(JSON.stringify(body), {
    status,
