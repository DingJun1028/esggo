        ...
        try {
            ...
            if (blueRes.ok) {
                ...
                if (blueJson.ok && blueJson.records?.length > 0) {
                    ...
                    const mapped = blueJson.records.map((rec, idx) => ({
                        id: rec.id || idx + 1,
