export function useExport() {
    const exportDocx = async (chapters, generatedContent, showToast) => {
    ...
    const exportPdf = async (chapters, generatedContent, showToast) => {
    ...
    const exportMarkdown = async (chapters, generatedContent, showToast) => {
