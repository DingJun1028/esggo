...
exports.ZKPDifficulty = exports.HashAlgorithm = void 0;
exports.computeHash = computeHash;
exports.computeSHA256 = computeSHA256;
exports.computeSHA256Async = computeSHA256Async;
exports.computeMultiLevelHash = computeMultiLevelHash;
...
})(ZKPDifficulty || (exports.ZKPDifficulty = ZKPDifficulty = {}));
async function computeHash(content, algorithm = HashAlgorithm.SHA512, difficulty = ZKPDifficulty.LOW) {
...
function generateZKPProof(hash, difficulty) {
    ...
    do {
        ...
        const proofHash = (0, crypto_1.createHash)('sha256').update(input).digest('hex');
        proof = proofHash;
        nonce++;
...
async function computeSHA256Async(content) {
    return computeSHA256(content);
}
async function computeMultiLevelHash(content, metadata) {
...
// 驗證雜湊
// ============================================
async function verifyHash(content, expectedHash) {
...
// HMAC 簽名
// ============================================
async function computeHMAC(content, secret) {
    const hmac = (0, crypto_1.createHmac)('sha256', secret);
    hmac.update(content);
    return hmac.digest('hex');
}
async function verifyHMAC(content, signature, secret) {
...
async function generateContentFingerprint(content, contentType) {
