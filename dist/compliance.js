...
function checkE(data) {
    ...
    (0, logger_1.logEvent)('Compliance', 'checkE', data, { passed, messages: msgs });
...
function checkS(data) {
    ...
    if (!data.communityEngagement)
        msgs.push('缺少社會參與説明');
    const passed = msgs.length === 0;
    (0, logger_1.logEvent)('Compliance', 'checkS', data, { passed, messages: msgs });
    return { passed, messages: msgs };
}
function checkG(data) {
    const msgs = [];
    ...
    if (!data.ethics)
        msgs.push('缺少道德規範説明');
    const passed = msgs.length === 0;
    (0, logger_1.logEvent)('Compliance', 'checkG', data, { passed, messages: msgs });
    return { passed, messages: msgs };
}
function runComplianceCheck(payload) {
    ...
    (0, logger_1.logEvent)('Compliance', 'runAll', payload, { e, s, g });
    return { e, s, g };
}
