...
export class OmniRestoration {
     ...
     */
    static async validateChain(uuid) {
     ...
     */
    static async recomposeGhost(uuid) {
     ...
     */
    static async alignSemantics(component) {
        ...
        const { hash_lock, ...baseComponent } = component;
...
//# sourceMappingURL=omni-restoration.js.map