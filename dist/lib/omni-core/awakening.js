...
export class OmniAgentAwakening {
    constructor() {
    ...
    registerHooks() {
        // 監聽任意代理習得新技能的事件廣播
        omniAgentBus.subscribe('agent:skill:learned', async (payload) => {
...
//# sourceMappingURL=awakening.js.map