...
exports.OmniSoul = void 0;
const crypto_proof_1 = require("../../../lib/crypto-proof");
...
class OmniSoul {
    ...
    async engrave(data) {
        const hash = await (0, crypto_proof_1.sha256)(JSON.stringify(data));
        const evidence = {
