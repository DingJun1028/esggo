...
export class ImpulsorEngine {
    ...
    registerHooks() {
        // 監聽ADK_Bus事件
        omniAgentBus.subscribe('adk:shield:forge', async (payload) => {
        ...
        omniAgentBus.subscribe('adk:drift:cloak', async (payload) => {
        ...
        omniAgentBus.subscribe('adk:bound', async (payload) => {
...
//# sourceMappingURL=impulsor.js.map