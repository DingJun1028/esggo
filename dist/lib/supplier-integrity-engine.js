...
export class SupplierIntegrityEngine {
     ...
     */
    async verifySupplierAttestation(supplierId, attestation, mockAIResult) {
     ...
     */
    getAggregateSupplyScore(results) {
        if (results.length === 0)
            return 0;
...
//# sourceMappingURL=supplier-integrity-engine.js.map