...
const memoryEvents = [];
export class SupabaseOmniRealtimeService {
    constructor() {
        this.channel = null;
    ...
    connect(user, callbacks) {
        ...
        this.channel
            ...
            const users = Object.values(newState).flatMap((arr) => arr || []);
...
//# sourceMappingURL=SupabaseOmniRealtimeService.js.map