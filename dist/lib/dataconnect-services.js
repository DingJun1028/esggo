...
import { listReports, getReportById, upsertReport, listScrapedArticles, listAuditRecords, listAllTasks, listRoadmapMilestones, upsertRoadmapMilestone, getCompanyProfile, upsertCompanyProfile, listEternalMemories, insertEternalMemory, insertAuditRecord, listSwarmAgentTasks, upsertSwarmAgentTask, listRegulatoryPolicies, } from '@dataconnect/generated';
/**
 * Data Connect Service Layer
 * This module provides type-safe access to the PostgreSQL backend via GraphQL.
 */
// --- Eternal Memory ---
export const dcListEternalMemories = async () => {
    try {
...
export const dcInsertEternalMemory = async (input) => {
    try {
...
// --- Swarm Agent Tasks ---
export const dcListSwarmAgentTasks = async () => {
    try {
...
export const dcUpsertSwarmAgentTask = async (input) => {
    try {
...
// --- Regulatory Policies ---
export const dcListRegulatoryPolicies = async () => {
    try {
...
// --- Reports ---
export const dcGetReports = async () => {
    try {
...
export const dcGetReportById = async (id) => {
    try {
...
// --- Intelligence ---
export const dcListScrapedArticles = async () => {
    try {
...
// --- Audit ---
export const dcListAuditRecords = async () => {
    try {
...
export const dcUpsertAuditRecord = async (input) => {
    try {
...
// --- Roadmap ---
export const dcGetRoadmapMilestones = async () => {
    try {
...
export const dcUpsertMilestone = async (input) => {
    try {
...
// --- Company Profile ---
export const dcGetCompanyProfile = async (id) => {
    try {
...
export const dcUpsertCompanyProfile = async (input) => {
    try {
