...
// PDF 轉換
export const convertHtmlToPdf = async (htmlContent, filename = 'document.pdf') => {
...
// DOCX 轉換
export const convertHtmlToDocx = async (htmlContent, filename = 'document.docx') => {
...
export const convertHtmlToMarkdown = (htmlContent) => {
...
//# sourceMappingURL=documentConverters.js.map