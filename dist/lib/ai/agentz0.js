...
export class AgentZ0 {
    ...
    async runTask(taskDescription, dataContext) {
...
Please analyze the request, use any available tools to query the databases for necessary data, and provide a professional, structured response.
    ...
    async *streamTask(taskDescription, dataContext) {
...
export async function runESGMultiAgentWorkflow(topic) {
    ...
    const auditResult = await esgAuditAgent.runTask(`Audit the following research findings for compliance accuracy`, { researchData: researchResult.result });
    return {
        research: researchResult,
        audit: auditResult
    };
}
//# sourceMappingURL=agentz0.js.map