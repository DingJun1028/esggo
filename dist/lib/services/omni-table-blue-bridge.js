...
export class OmniTableBlueBridge {
     ...
     */
    async syncMetricsToCloud(datasheetId) {
        ...
        try {
            ...
            for (const record of records) {
                ...
                const recordId = record.id || record.recordId || 'unknown';
     ...
     */
    async reportCloudStatusToOmniTable(datasheetId, recordId) {
...
//# sourceMappingURL=omni-table-blue-bridge.js.map