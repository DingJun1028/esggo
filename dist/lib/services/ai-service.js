...
export async function analyzeGreenwashingRisk(text) {
    const prompt = `
...
export async function generateGRIContent(chapter, persona, companyContext, existingData) {
...
export async function chatWithESGAssistant(messages, persona, companyContext) {
...
export async function generateESGSummary(reportData) {
    const prompt = `
...
export async function refineESGText(text, mode) {
