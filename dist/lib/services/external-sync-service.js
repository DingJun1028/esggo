...
export class ExternalSyncService {
     ...
     */
    async syncToOmniTable(datasheetId, payload) {
     ...
     */
    async syncToOmniBlue(endpoint, payload) {
     ...
     */
    async triggerEvolutionSync(event) {
...
//# sourceMappingURL=external-sync-service.js.map