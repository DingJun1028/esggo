...
export const AtomicBadge = ({ variant = 'default', className, children, ...props }) => {
    ...
    return (_jsx("span", { className: cn('inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold tracking-wider uppercase font-mono', variantClasses, className), ...props, children: children }));
};
