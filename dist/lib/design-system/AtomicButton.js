...
export const AtomicButton = React.forwardRef(({ variant = 'default', className, type = 'button', children, ...props }, ref) => {
    useEffect(() => {
        const atom = {
            atomId: 'ATOM_BTN_001',
            type: 'atom',
    ...
    return (_jsxs("button", { ref: ref, type: type, className: cn(baseClasses, variantClasses, defaultPadding, className), ...props, children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none", "aria-hidden": "true" }), _jsx("span", { className: "relative z-10 flex items-center justify-center gap-2", children: children })] }));
});
