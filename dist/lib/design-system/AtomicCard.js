...
export const AtomicCard = React.forwardRef(({ glassIntensity = 'medium', hoverEffect = 'none', padding = 'md', className, children, ...props }, ref) => {
    useEffect(() => {
        const atom = {
            atomId: 'ATOM_CRD_001',
            type: 'atom',
    ...
    return (_jsx("div", { ref: ref, className: cn("rounded-xl relative overflow-hidden", glassClasses, hoverClasses, paddingClasses, className), ...props, children: children }));
});
