...
export class SustainWriteScribe {
    async expandChapter(task) {
        ...
        await saveSustainWriteSection({
            company_id: context.companyId || 'default',
     ...
     */
    async generateDeepOutline(title, gri, depth) {
     ...
     */
    async generateExpertParagraph(mainTitle, sectionTitle, subTitle, focus, context, depth) {
     ...
     * 模擬的高品質長文生成 (Fallback)
     */
    generateMockExpertText(mainTitle, subTitle, focus, depth) {
        const paragraphs = [
...
//# sourceMappingURL=sustain-scribe.js.map