...
export class QkpHealingAgent {
    constructor() {
        this.botSignature = 'BLUE_Automation_Bot';
        this.core = {
    ...
    initializeAgent() {
        ...
        // 訂閱來自事件總線的治療需求
        omniAgentBus.subscribe('qkp:healing:triggered', async (payload) => {
            try {
     ...
     * 執行降維自癒與共識對齊演算法
     */
    async executeHealingWorkflow(evidenceUuid, severity) {
...
//# sourceMappingURL=qkp-healing-agent.js.map