...
exports.BerkeleyComponent = exports.DesignTokens = exports.T5Validator = exports.ZKPValidator = exports.HashLock = exports.T5Protocol = void 0;
...
})(T5Protocol || (exports.T5Protocol = T5Protocol = {}));
// Hash Lock 強化實現 - SHA-512 + HMAC-ZKP
class HashLock {
    static async lock(data) {
        const hmac = (0, crypto_1.createHmac)('sha512', HMAC_SECRET);
        hmac.update(data);
        return hmac.digest('hex');
    }
    static verify(data, hash) {
        const recomputed = (0, crypto_1.createHmac)('sha512', HMAC_SECRET)
            .update(data)
            .digest('hex');
...
class ZKPValidator {
    static generateProof(data, nonce) {
        const hash = (0, crypto_1.createHmac)('sha512', HMAC_SECRET)
            .update(`${data}:${nonce}`)
            .digest('hex');
        return hash;
    }
...
exports.T5Validator = T5Validator;
// 極簡設計 Token
...
exports.BerkeleyComponent = BerkeleyComponent;
