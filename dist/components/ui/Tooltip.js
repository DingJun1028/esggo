...
export function Tooltip({ content, children, position = 'top', className, evidenceUuid }) {
    ...
    return (_jsxs("div", { className: cn('relative inline-flex', className), onMouseEnter: () => setVisible(true), onMouseLeave: () => setVisible(false), children: [children, visible && (_jsx("div", { className: cn('absolute z-50 px-2.5 py-1.5 rounded-[7px] text-[12px] text-white whitespace-nowrap shadow-lg pointer-events-none', positionClasses[position], bgStyle), children: displayContent }))] }));
}
