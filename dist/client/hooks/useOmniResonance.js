...
exports.useOmniResonance = useOmniResonance;
const react_1 = require("react");
const evidence_store_1 = require("../stores/evidence.store");
function useOmniResonance() {
    const { evidences } = (0, evidence_store_1.useEvidenceStore)();
    const [isCrystallizing, setIsCrystallizing] = (0, react_1.useState)(false);
    const [noise, setNoise] = (0, react_1.useState)(0);
    // 1. 使用 useMemo 計算基礎共鳴值（純函數計算）
    const baseResonanceData = (0, react_1.useMemo)(() => {
    ...
    const [streamStatus, setStreamStatus] = (0, react_1.useState)({ ren: 100, du: 100 });
    // 2. 設定週期性更新（模擬生命感）
    (0, react_1.useEffect)(() => {
...
//# sourceMappingURL=useOmniResonance.js.map