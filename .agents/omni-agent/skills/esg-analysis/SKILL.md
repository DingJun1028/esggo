---
name: esg-analysis
description: ESG 數據分析與 GRI/CSRD/TCFD 報告生成技能。當需要進行 ESG 合規查覈、碳排計算、永續報告草稿時使用。
version: 1.0.0
metadata:
  omni-agent:
...
| 臺灣金管會 | 上市公司揭露規範 | "臺灣永續報告書 金管會 2025" |
...
omni_agent.delegate_task(tasks=[
  {
    ...
    "context": "聚焦：歐盟 CSRD 強制揭露時程、GRI 對應、臺灣企業適用範圍",
