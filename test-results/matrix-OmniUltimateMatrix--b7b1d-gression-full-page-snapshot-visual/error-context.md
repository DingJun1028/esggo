...
- Name: matrix.spec.ts >> OmniUltimateMatrix Visual Regression >> full page snapshot
- Location: tests\vrt\matrix.spec.ts:4:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/dashboard/matrix
Call log:
