...
- Name: omni-notes.spec.ts >> OmniNotes Workspace (5T Protocol) >> should render OmniNotes workspace and verify basic visual layout
- Location: tests\vrt\omni-notes.spec.ts:4:3
...
Call log:
  - navigating to "/omni-notes", waiting until "networkidle"
