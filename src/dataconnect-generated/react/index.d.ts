import { ListAllTasksData, GetTaskByIdData, GetTaskByIdVariables, UpsertTaskData, UpsertTaskVariables, ListAuditRecordsData, InsertAuditRecordData, InsertAuditRecordVariables, ListScrapedArticlesData, ListRoadmapMilestonesData, UpsertRoadmapMilestoneData, UpsertRoadmapMilestoneVariables, GetCompanyProfileData, GetCompanyProfileVariables, UpsertCompanyProfileData, UpsertCompanyProfileVariables, GetReportByIdData, GetReportByIdVariables, UpsertReportData, UpsertReportVariables, UpsertReportSectionData, UpsertReportSectionVariables, ListReportSectionsByReportData, ListReportSectionsByReportVariables, UpsertCompanyMetricData, UpsertCompanyMetricVariables, ListCompanyMetricsData, ListCompanyMetricsVariables, InsertEternalMemoryData, InsertEternalMemoryVariables, ListEternalMemoriesByCompanyData, ListEternalMemoriesByCompanyVariables, GetReportByCompanyData, GetReportByCompanyVariables, ListReportsData, UpsertScrapedArticleData, UpsertScrapedArticleVariables, ListEternalMemoriesData, ListSwarmAgentTasksData, UpsertSwarmAgentTaskData, UpsertSwarmAgentTaskVariables, ListRegulatoryPoliciesData, GetMyCompanyProfileData } from '../';
...
export function useInsertAuditRecord(options?: useDataConnectMutationOptions<InsertAuditRecordData, FirebaseError, InsertAuditRecordVariables | void>): UseDataConnectMutationResult<InsertAuditRecordData, InsertAuditRecordVariables>;
export function useInsertAuditRecord(dc: DataConnect, options?: useDataConnectMutationOptions<InsertAuditRecordData, FirebaseError, InsertAuditRecordVariables | void>): UseDataConnectMutationResult<InsertAuditRecordData, InsertAuditRecordVariables>;
...
export function useInsertEternalMemory(options?: useDataConnectMutationOptions<InsertEternalMemoryData, FirebaseError, InsertEternalMemoryVariables>): UseDataConnectMutationResult<InsertEternalMemoryData, InsertEternalMemoryVariables>;
export function useInsertEternalMemory(dc: DataConnect, options?: useDataConnectMutationOptions<InsertEternalMemoryData, FirebaseError, InsertEternalMemoryVariables>): UseDataConnectMutationResult<InsertEternalMemoryData, InsertEternalMemoryVariables>;
...
export function useGetMyCompanyProfile(options?: useDataConnectQueryOptions<GetMyCompanyProfileData>): UseDataConnectQueryResult<GetMyCompanyProfileData, undefined>;
export function useGetMyCompanyProfile(dc: DataConnect, options?: useDataConnectQueryOptions<GetMyCompanyProfileData>): UseDataConnectQueryResult<GetMyCompanyProfileData, undefined>;
