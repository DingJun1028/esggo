...
export function useUpsertAuditRecord(options?: useDataConnectMutationOptions<UpsertAuditRecordData, FirebaseError, UpsertAuditRecordVariables>): UseDataConnectMutationResult<UpsertAuditRecordData, UpsertAuditRecordVariables>;
export function useUpsertAuditRecord(dc: DataConnect, options?: useDataConnectMutationOptions<UpsertAuditRecordData, FirebaseError, UpsertAuditRecordVariables>): UseDataConnectMutationResult<UpsertAuditRecordData, UpsertAuditRecordVariables>;
