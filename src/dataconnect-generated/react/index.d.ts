...
export function useListUserTasks(
  options?: useDataConnectQueryOptions<ListUserTasksData>
): UseDataConnectQueryResult<ListUserTasksData, undefined>;
export function useListUserTasks(
  dc: DataConnect,
  options?: useDataConnectQueryOptions<ListUserTasksData>
): UseDataConnectQueryResult<ListUserTasksData, undefined>;
...
export function useGetTaskById(
  ...
  options?: useDataConnectQueryOptions<GetTaskByIdData>
): UseDataConnectQueryResult<GetTaskByIdData, GetTaskByIdVariables>;
export function useGetTaskById(
  dc: DataConnect,
  vars: GetTaskByIdVariables,
  options?: useDataConnectQueryOptions<GetTaskByIdData>
