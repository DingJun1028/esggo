// ============================================================
// Solid Card UI Component Library
// src/components/ui/solid-card.tsx
//
// Solid Card design system: Teal (#009EB0) + Gold (#D4AF37) + ZKP Blue (#3B82F6)
// Professional, data-driven, zero decorative fluff
// ============================================================

import React from 'react';

// --- Design Tokens (inline to avoid Tailwind config dependency) ---
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <div>
          <h3 style={{ margin: 0, fontSize: '16px', fontWeight: 600, color: TOKENS.text }}>{title}</h3>
...
export function Badge({ children, variant = 'teal', size = 'sm' }: BadgeProps) {
  const bgColors: Record<string, string> = {
    teal: `${TOKENS.teal}18`,
    gold: `${TOKENS.gold}18`,
    blue: `${TOKENS.zkpBlue}18`,
    success: `${TOKENS.success}18`,
    warning: `${TOKENS.warning}18`,
    error: `${TOKENS.error}18`,
    muted: `${TOKENS.textMuted}18`,
  };
