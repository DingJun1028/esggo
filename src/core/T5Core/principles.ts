...
export interface T5Principle {
  id: string;
  name: string;
  description: string;
  impact: number; // 1-10 scale
  verification: string; // method of verification
}

// Define the five T5 principles
export const T5_PRINCIPLES: Record<string, T5Principle> = {
  TRACEABLE: {
    id: 'T1',
    name: 'Traceable',
