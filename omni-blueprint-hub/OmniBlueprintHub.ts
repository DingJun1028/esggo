...
export class OmniBlueprintHub {
  ...
  public createBlueprint(
    ...
    const blueprint: BlueprintDefinition = {
      ...
      evidence: {
        ...
        processTrace: ['BLUEPRINT_CREATED', 'ISO-14064-1'],
        finalEffect: 'Blueprint successfully generated'
      }
    };
  ...
  public manifestToProduct(blueprint: BlueprintDefinition): BlueprintProduct {
    ...
    const product: BlueprintProduct = {
      ...
      evidence: {
        ...
        processTrace: [...blueprint.evidence.processTrace, 'PRODUCT_MANIFESTED'],
        finalEffect: 'Product successfully manifested'
      }
    };
  ...
  public freezeProduct(product: BlueprintProduct): Readonly<BlueprintProduct> {
    ...
    product.evidence.processTrace.push('PRODUCT_FROZEN');
    product.evidence.finalEffect = `FROZEN_HASH:${this.generateHashLock(product)}`;
