...
version: "1.0"
author: OA-Team 30 蜂群 (Hermes autonomous curation)
license: AGPL-3.0
description: 文檔聲稱升級為可重複驗證閉環的寫腳本技法（comment 誤判 + monorepo 掃描超時坑）。
metadata:
  hermes:
    tags: [oa-team, verification, gap-remediation, 5t, monorepo, single-source, esggo]
    related_skills: [oa-gap-remediation-playbook, esggo-monorepo-build, oa-team-soul-canon]
---
