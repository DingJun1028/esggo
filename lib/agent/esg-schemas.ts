...
// 驗證工具
export const validateAgentStep = (data: unknown): AgentStep => {
  return AgentStepSchema.parse(data);
};

export const validateTaskInput = (data: unknown): TaskInput => {
  return TaskInputSchema.parse(data);
};

export const validateContractInput = (data: unknown): ContractInput => {
  return ContractInputSchema.parse(data);
};

export const validateESGProposal = (data: unknown): ESGProposal => {
