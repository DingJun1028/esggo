...
exports.memoryGraphEngine = exports.MemoryGraphEngine = void 0;
class MemoryGraphEngine {
     ...
     */
    async buildLineageGraph(component, policy, resonance) {
        const nodes = [];
        const edges = [];
...
exports.memoryGraphEngine = MemoryGraphEngine.getInstance();
//# sourceMappingURL=memory-graph-engine.js.map