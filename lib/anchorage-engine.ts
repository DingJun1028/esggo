...
export class AnchorageEngine {
  private static instance: AnchorageEngine;
   ...
   */
  async anchorBatch(masterSeals: string[]): Promise<AnchorageReceipt> {
   ...
   */
  async verifyInBatch(seal: string, receipt: AnchorageReceipt, allSealsInBatch: string[]): Promise<boolean> {
